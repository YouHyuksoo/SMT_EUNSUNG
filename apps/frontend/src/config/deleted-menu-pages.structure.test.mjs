...
const deletedRouteDirs = [
  ...
  "apps/frontend/src/app/(authenticated)/master/process-capa",
...
const deletedRegistryFiles = [
  ...
  "apps/frontend/src/components/layout/page-registries/master__process-capa.generated.ts",
...
test("은성 메뉴 상위 구조는 시스템 카테고리를 포함한다", () => {
