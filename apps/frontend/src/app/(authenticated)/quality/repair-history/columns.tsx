...
export const repairHistoryColumns: ColumnDef<RepairHistoryRow>[] = [
  ...
  { accessorKey: 'repairLineCode', header: '수리라인', size: 110, cell: ctx => ctx.row.original.repairLineName ?? ctx.getValue() ?? '' },
  { accessorKey: 'repairWorkstageCode', header: '수리공정', size: 120, cell: ctx => ctx.row.original.repairWorkstageName ?? ctx.getValue() ?? '' },
