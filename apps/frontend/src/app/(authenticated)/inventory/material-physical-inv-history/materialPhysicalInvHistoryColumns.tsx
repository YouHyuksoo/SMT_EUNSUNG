...
export interface CreateMaterialPhysicalInvHistoryGridColumnsOptions {
  t: TFunction;
}

export function createMaterialPhysicalInvHistoryGridColumns({
  t,
}: CreateMaterialPhysicalInvHistoryGridColumnsOptions): ColumnDef<InvHistoryItem>[] {
  return [
    {
