...
import { createCustomerPoStatusGridColumns } from "./customerPoStatusColumns";
...
export default function CustomerPoStatusPage() {
  ...
  const columns = useMemo(() => createCustomerPoStatusGridColumns(t), [t]);
