...
export interface CreateProductIssueCancelGridColumnsOptions {
  t: TFunction;
  onCancelTx: (tx: ProductIssueTx) => void;
}

export function createProductIssueCancelGridColumns({
  t,
  onCancelTx,
}: CreateProductIssueCancelGridColumnsOptions): ColumnDef<ProductIssueTx>[] {
  return [
    {
    ...
    },
    {
      ...
      header: () => <StatusHeaderHelp label={t("productMgmt.issueCancel.transType")} codeType="TRANSACTION_TYPE" align="center" />,
      size: 110,
    ...
    },
    {
      ...
      header: () => <StatusHeaderHelp label={t("productMgmt.issueCancel.issueType")} codeType="ISSUE_TYPE" align="center" />,
      size: 110,
      cell: ({ getValue }) => {
        const v = getValue() as string | null;
