...
export const PROD_LINE_FIELD_HELP = {
  ...
  processCode: { db: "IP_PRODUCT_LINE.PROCESS_CODE", description: "OEE 집계 기준 작업장입니다. SMT 또는 조립(ASSY)을 선택합니다." },
  resourceType: { db: "IP_PRODUCT_LINE.RESOURCE_TYPE", description: "OEE에서 라인 또는 셀로 집계할 유형입니다." },
  parentLineCode: { db: "IP_PRODUCT_LINE.PARENT_LINE_CODE", description: "LINE은 자기 라인코드, CELL은 소속될 다른 생산라인을 지정합니다." },
