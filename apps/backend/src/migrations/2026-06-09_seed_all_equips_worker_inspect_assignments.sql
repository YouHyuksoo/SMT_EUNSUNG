-- 모든 사용 설비에 작업자설비점검 표준 항목을 할당한다.
-- QR 값은 설비코드:항목코드 형태로 고정한다. 예: EQ-CRIMP-01:EIP-STD-W001
...
ON (
  ...
  AND target.INSPECT_TYPE = 'WORKER'
...
WHEN MATCHED THEN UPDATE SET
  ...
  target.WORKER_QR_CODE = src.WORKER_QR_CODE,
