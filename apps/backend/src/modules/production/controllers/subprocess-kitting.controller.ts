...
export class SubprocessKittingController {
  ...
  async issueSgLabel(
    ...
    const data = await this.service.issueSgLabel(dto, organizationId, req.user?.id ?? 'system');
  ...
  async confirmSubKit(
    ...
    const data = await this.service.confirmSubKit(dto, organizationId, req.user?.id ?? 'system');
  ...
  async getCircuitsByOrder(
    ...
    const data = await this.service.getCircuitsByOrder(orderNo, organizationId);
  ...
  async getSgLabelsByResult(
    ...
    const data = await this.service.getSgLabelsByResult(resultNo, organizationId);
    return ResponseUtil.success(data);
  }
  ...
  async getAssemblyRequirements(
    ...
    const data = await this.service.getAssemblyRequirements(orderNo, organizationId);
    return ResponseUtil.success(data);
  }
  ...
  async getSgLabel(
    ...
    const data = await this.service.getSgLabel(sgBarcode, organizationId);
    return ResponseUtil.success(data);
  }
}
