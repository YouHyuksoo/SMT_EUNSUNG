...
export const DEFAULT_MENU_CATEGORY_LAYOUT: readonly DefaultMenuCategoryLayout[] = [
  ...
  { categoryCode: 'OEE', labelKey: 'menu.oee', sortOrder: 20, menuCodes: ['OEE_DASHBOARD', 'OEE_DRILLDOWN', 'OEE_ENTRY', 'OEE_MULTI_ENTRY', 'OEE_EQUIP_WORK_RESULT', 'OEE_EQUIP_OPS_ANALYSIS', 'OEE_EQUIP_DOWNTIME_MOBILE', 'OEE_MST_STD_TIME', 'OEE_MST_IDLE_REASON', 'OEE_MST_EQUIP_REASON', 'OEE_MST_RESOURCE'] },
