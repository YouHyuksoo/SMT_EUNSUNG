...
export class DepartmentController {
  ...
  async findAll(@Query() query: DepartmentQueryDto, @OrganizationId() organizationId: number) {
    const result = await this.departmentService.findAll(query, organizationId);
  ...
  async create(@Body() dto: CreateDepartmentDto, @OrganizationId() organizationId: number) {
  ...
  async update(@Param('id') id: string, @Body() dto: UpdateDepartmentDto, @OrganizationId() organizationId: number) {
