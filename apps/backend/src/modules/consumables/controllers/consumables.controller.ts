...
export class ConsumablesController {
  ...
  async findAll(@Query() query: ConsumableQueryDto, @OrganizationId() organizationId: number) {
    const result = await this.consumablesService.findAll(query, organizationId);
  ...
  async getSummary(@OrganizationId() organizationId: number) {
    const data = await this.consumablesService.getSummary(organizationId);
  ...
  @ApiResponse({ status: 200, description: '조회 성공' })
  async getWarningList(@OrganizationId() organizationId: number) {
    const data = await this.consumablesService.getWarningList(organizationId);
    return ResponseUtil.success(data);
  }
  ...
  @ApiResponse({ status: 200, description: '조회 성공' })
  async getLifeStatus(@OrganizationId() organizationId: number) {
    const data = await this.consumablesService.getLifeStatus(organizationId);
    return ResponseUtil.success(data);
  }
  ...
  async getStockStatus(
    ...
    const result = await this.consumablesService.getStockStatus(query, organizationId);
    return ResponseUtil.paged(result.data, result.total, result.page, result.limit);
  }
  ...
  async findUsageMaps(@Param('id') id: string, @OrganizationId() organizationId: number) {
    const data = await this.consumablesService.findUsageMaps(id, organizationId);
    return ResponseUtil.success(data);
  }
  ...
  async createUsageMap(
    ...
    const data = await this.consumablesService.createUsageMap(id, dto, organizationId);
  ...
  async updateUsageMap(
    ...
    const data = await this.consumablesService.updateUsageMap(id, productItemCode, equipCode, dto, organizationId);
  ...
  async deleteUsageMap(
    ...
    await this.consumablesService.deleteUsageMap(id, productItemCode, equipCode, organizationId);
  ...
  async findAllLogs(
    ...
    const result = await this.consumablesService.findAllLogs(query, organizationId);
    return ResponseUtil.paged(result.data, result.total, result.page, result.limit);
  }
  ...
  async uploadImage(
    ...
    const data = await this.consumablesService.updateImage(id, imageUrl, organizationId);
  ...
  async removeImage(@Param('id') id: string, @OrganizationId() organizationId: number) {
    const existing = await this.consumablesService.findById(id, organizationId);
    ...
    const data = await this.consumablesService.updateImage(id, null, organizationId);
  ...
  async findById(@Param('id') id: string, @OrganizationId() organizationId: number) {
    const data = await this.consumablesService.findById(id, organizationId);
    return ResponseUtil.success(data);
  }
  ...
  async create(@Body() dto: CreateConsumableDto, @OrganizationId() organizationId: number) {
    const data = await this.consumablesService.create(dto, organizationId);
  ...
  async update(@Param('id') id: string, @Body() dto: UpdateConsumableDto, @OrganizationId() organizationId: number) {
    const data = await this.consumablesService.update(id, dto, organizationId);
  ...
  async delete(@Param('id') id: string, @OrganizationId() organizationId: number) {
    await this.consumablesService.delete(id, organizationId);
  ...
  @ApiResponse({ status: 201, description: '등록 성공' })
  async createLog(@Body() dto: CreateConsumableLogDto, @OrganizationId() organizationId: number) {
    const data = await this.consumablesService.createLog(dto, organizationId);
  ...
  @ApiResponse({ status: 201, description: '등록 성공' })
  async createReceiving(@Body() dto: CreateConsumableLogDto, @OrganizationId() organizationId: number) {
    const data = await this.consumablesService.createLog(dto, organizationId);
  ...
  @ApiResponse({ status: 201, description: '등록 성공' })
  async createIssuing(@Body() dto: CreateConsumableLogDto, @OrganizationId() organizationId: number) {
    const data = await this.consumablesService.createLog(dto, organizationId);
  ...
  async updateShotCount(@Body() dto: UpdateShotCountDto, @OrganizationId() organizationId: number) {
    const data = await this.consumablesService.updateShotCount(dto, organizationId);
  ...
  async resetShotCount(@Body() dto: ResetShotCountDto, @OrganizationId() organizationId: number) {
    const data = await this.consumablesService.resetShotCount(dto, organizationId);
