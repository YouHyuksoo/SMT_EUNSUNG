...
const rows: WorktimeRangeRow[] = [
  ...
  { workType: 'E', startTime: '163000', endTime: '183000', attribute01: null, attribute02: null },
  { workType: 'F', startTime: '183000', endTime: '223000', attribute01: null, attribute02: null },
  ...
  { workType: 'I', startTime: '023000', endTime: '073000', attribute01: '1', attribute02: '1' },
  { workType: 'J', startTime: '073000', endTime: '083000', attribute01: '1', attribute02: '1' },
];

describe('resolveOeeMobileWorkContext', () => {
  it.each([
    ['2026-08-07T08:29:59+09:00', '2026-08-06', 'J'],
    ['2026-08-07T08:30:00+09:00', '2026-08-07', 'A'],
    ['2026-08-07T22:30:00+09:00', '2026-08-07', 'G'],
    ['2026-08-08T00:30:00+09:00', '2026-08-07', 'H'],
    ['2026-08-08T08:29:59+09:00', '2026-08-07', 'J'],
  ...
  it('uses Asia/Seoul regardless of the host timezone', () => {
    ...
    try {
      ...
      ).toEqual({ workDate: '2026-08-07', workSegment: 'A' });
    } finally {
