...
This file defines how Codex coding agents should work in this repository.
It is derived from `CLAUDE.md` and adapted for Codex while preserving the
...
These rules are intentionally kept in this repo. They reduce recurring LLM coding failures:
guessing, overbuilding, touching unrelated code, and claiming completion without verification.
...
- Keep responses concise and include verification results when work is completed.
