 ...
 */
import type { CalendarBreak, CalendarLineRun, CalendarShift, ShiftTimeMasterLike, ShiftTimeSpan, WorkDayType } from './types';
/** 양력 고정공휴일 [월, 일] */
 ...
 */
export declare function calendarWorkMinutes(dayType: WorkDayType, shifts: readonly CalendarShift[], breaks: readonly CalendarBreak[], lineRuns?: readonly CalendarLineRun[]): number;
/** 라인 추가 운영 한 행의 가동분. 자정 넘김은 교대조와 같은 규칙이다. */
export declare function lineRunMinutes(run: CalendarLineRun): number;
