...
// ===== 입하 상태 =====
exports.RECEIVE_STATUS_VALUES = ['PENDING', 'IQC_IN_PROGRESS', 'PASSED', 'FAILED'];
// ===== 출고 상태 =====
...
// ===== IQC 검사구분 =====
exports.IQC_INSPECT_METHOD_VALUES = ['FULL', 'SKIP'];
// ===== IQC 검사 유형 =====
exports.IQC_INSPECT_TYPE_VALUES = ['INITIAL', 'RETEST'];
// ===== 폐기 사유 =====
...
// ===== 자재 LOT IQC 상태 =====
exports.IQC_STATUS_VALUES = ['PENDING', 'PASS', 'FAIL', 'HOLD'];
// ===== 자재 LOT 상태 =====
