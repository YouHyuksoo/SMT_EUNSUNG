/**
 * @file src/components/quality/DashboardSidebar.tsx
 * @description Sidebar controls for quality dashboards.
 */
...
import type { DashboardSettings } from "@/types/quality-dashboard";
import { DEFAULT_SETTINGS } from "@/types/quality-dashboard";
