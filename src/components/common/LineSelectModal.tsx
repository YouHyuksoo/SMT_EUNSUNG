 ...
 * @description Line selection modal with grouped checkboxes.
 */
'use client';
      ...
      <div className="w-full max-w-2xl max-h-[80vh] bg-gray-900 border border-gray-700 rounded-xl shadow-2xl flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-700 shrink-0">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              {required && !hasSaved
                ? t('lineSelectRequired')
                : t('selectedLines', { count: selected.size })}
            </p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
          ...
          <div className="rounded-lg border border-gray-700 p-4 space-y-3">
            <h3 className="text-sm font-semibold text-gray-300">{t('timingSection')}</h3>
            <div className="flex items-center gap-3">
              <label className="w-24 shrink-0 text-xs text-gray-400">{t('refreshLabel')}</label>
              <input
                type="range"
            ...
            <div className="flex items-center gap-3">
              <label className="w-24 shrink-0 text-xs text-gray-400">{t('scrollLabel')}</label>
              <input
                type="range"
                min={3} max={60} step={1}
