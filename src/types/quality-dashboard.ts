/**
 * @file src/types/quality-dashboard.ts
 * @description 품질 분석 대시보드 타입 정의
 *
 * 초보자 가이드:
 * 1. QC 테이블 10종 차트 데이터 + 요약 + 수리율
 * 2. RAW 테이블 6종 인사이트 데이터
 * 3. 사이드바 설정: 레이아웃/높이/팔레트/17종 토글
 */
...
export interface NgMatrixItem {
  name: string;
  [proc: string]: string | number;
}
