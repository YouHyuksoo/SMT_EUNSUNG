HA$PBExportHeader$uo_supplier_name_code.sru
forward
global type uo_supplier_name_code from dropdownlistbox
end type
type st_customer from structure within uo_supplier_name_code
end type
end forward
...
global uo_supplier_name_code uo_supplier_name_code
...
on uo_supplier_name_code.create
end on

on uo_supplier_name_code.destroy
end on
