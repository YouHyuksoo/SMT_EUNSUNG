HA$PBExportHeader$w_mat_buy_price_confirm.srw
$PBExportComments$Material Buy Price Master
forward
global type w_mat_buy_price_confirm from w_main_root
end type
type st_1 from so_statictext within w_mat_buy_price_confirm
end type
type ddlb_item_code from uo_item_code within w_mat_buy_price_confirm
end type
type ddlb_supplier_code from uo_supplier_code within w_mat_buy_price_confirm
end type
type st_3 from so_statictext within w_mat_buy_price_confirm
end type
type gb_1 from so_groupbox within w_mat_buy_price_confirm
end type
type st_14 from so_statictext within w_mat_buy_price_confirm
end type
type sle_item_name from so_singlelineedit within w_mat_buy_price_confirm
end type
type sle_1 from so_singlelineedit within w_mat_buy_price_confirm
end type
type st_4 from so_statictext within w_mat_buy_price_confirm
end type
type cb_confirm from so_commandbutton within w_mat_buy_price_confirm
end type
type cb_cancel from so_commandbutton within w_mat_buy_price_confirm
end type
type rb_wait from so_radiobutton within w_mat_buy_price_confirm
end type
type rb_confirmed from so_radiobutton within w_mat_buy_price_confirm
end type
type gb_2 from so_groupbox within w_mat_buy_price_confirm
end type
type gb_3 from so_groupbox within w_mat_buy_price_confirm
end type
end forward
...
integer width = 4681
integer height = 2848
string title = "Buy Price Confirm"
st_1 st_1
...
global w_mat_buy_price_confirm w_mat_buy_price_confirm

on w_mat_buy_price_confirm.create
int iCurrent
call super::create
...
on w_mat_buy_price_confirm.destroy
call super::destroy
destroy(this.st_1)
...
type dw_5 from w_main_root`dw_5 within w_mat_buy_price_confirm
integer y = 316
end type

type dw_4 from w_main_root`dw_4 within w_mat_buy_price_confirm
integer y = 316
end type

type dw_3 from w_main_root`dw_3 within w_mat_buy_price_confirm
integer y = 316
end type

type dw_2 from w_main_root`dw_2 within w_mat_buy_price_confirm
integer y = 316
...
type dw_1 from w_main_root`dw_1 within w_mat_buy_price_confirm
integer y = 316
integer width = 4544
integer height = 2416
boolean titlebar = true
string title = "Material Buy Price List"
string dataobject = "d_mat_buy_price_4_confirm_lst"
end type
...
type uo_tabpages from w_main_root`uo_tabpages within w_mat_buy_price_confirm
end type
