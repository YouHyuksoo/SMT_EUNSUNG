HA$PBExportHeader$w_des_bom_excel_form_default_popup.srw
$PBExportComments$$$HEX4$$d1c540c191c5ddc2$$ENDHEX$$
forward
global type w_des_bom_excel_form_default_popup from w_popup_root
end type
type cb_confirm from so_commandbutton within w_des_bom_excel_form_default_popup
end type
type cb_2 from so_commandbutton within w_des_bom_excel_form_default_popup
end type
type pb_1 from so_commandbutton within w_des_bom_excel_form_default_popup
end type
type mle_confirm_comment from so_multilineedit within w_des_bom_excel_form_default_popup
end type
type st_request_comment from so_statictext within w_des_bom_excel_form_default_popup
end type
type sle_revision from so_singlelineedit within w_des_bom_excel_form_default_popup
end type
type st_revision from so_statictext within w_des_bom_excel_form_default_popup
end type
type st_17 from so_statictext within w_des_bom_excel_form_default_popup
end type
type ddlb_work_no from uo_bom_workno within w_des_bom_excel_form_default_popup
end type
type st_set_item_code from so_statictext within w_des_bom_excel_form_default_popup
end type
type sle_set_item_code from so_singlelineedit within w_des_bom_excel_form_default_popup
end type
type sle_model_name from so_singlelineedit within w_des_bom_excel_form_default_popup
end type
type st_model_name from so_statictext within w_des_bom_excel_form_default_popup
end type
type sle_smt_model_name from so_singlelineedit within w_des_bom_excel_form_default_popup
end type
type st_2 from so_statictext within w_des_bom_excel_form_default_popup
end type
type sle_master_model_name from so_singlelineedit within w_des_bom_excel_form_default_popup
end type
type st_3 from so_statictext within w_des_bom_excel_form_default_popup
end type
type em_caarier_size from so_editmask within w_des_bom_excel_form_default_popup
end type
type st_4 from so_statictext within w_des_bom_excel_form_default_popup
end type
type gb_1 from so_groupbox within w_des_bom_excel_form_default_popup
end type
type gb_2 from so_groupbox within w_des_bom_excel_form_default_popup
end type
end forward
...
global w_des_bom_excel_form_default_popup w_des_bom_excel_form_default_popup
...
//if cbx_use_default_model.checked = true then 
		...
		LVS_CUSTOMER_MODEL_NAME = dw_1.object.item_desc[1]
		LVS_MODEL_NAME = dw_1.object.item_desc[1]
		LVS_SMT_MODEL_NAME = dw_1.object.item_desc[1]
		LVS_MASTER_MODEL_NAME =dw_1.object.item_desc[1]
		LVS_PART_NO = dw_1.object.part_no[1]
		lvs_parent_item_code = dw_1.object.part_no[1]
		LVS_MODEL_SPEC  =dw_1.object.comments[1]
...
//		LVS_PART_NO = SLE_SET_ITEM_code.TEXT //$$HEX8$$a8ba78b32000c8b9a4c230d1d0c52000$$ENDHEX$$PART NO $$HEX5$$5cb82000acc0a9c62000$$ENDHEX$$
//		lvs_parent_item_code =  sle_set_item_code.text ;
//		
...
do
	...
	dw_1.object.parent_part_no[i]      = lvs_parent_item_code	
...
on w_des_bom_excel_form_default_popup.create
int iCurrent
call super::create
...
this.Control[iCurrent+4]=this.mle_confirm_comment
this.Control[iCurrent+5]=this.st_request_comment
this.Control[iCurrent+6]=this.sle_revision
this.Control[iCurrent+7]=this.st_revision
this.Control[iCurrent+8]=this.st_17
this.Control[iCurrent+9]=this.ddlb_work_no
this.Control[iCurrent+10]=this.st_set_item_code
this.Control[iCurrent+11]=this.sle_set_item_code
this.Control[iCurrent+12]=this.sle_model_name
this.Control[iCurrent+13]=this.st_model_name
this.Control[iCurrent+14]=this.sle_smt_model_name
this.Control[iCurrent+15]=this.st_2
this.Control[iCurrent+16]=this.sle_master_model_name
this.Control[iCurrent+17]=this.st_3
this.Control[iCurrent+18]=this.em_caarier_size
this.Control[iCurrent+19]=this.st_4
this.Control[iCurrent+20]=this.gb_1
this.Control[iCurrent+21]=this.gb_2
end on

on w_des_bom_excel_form_default_popup.destroy
call super::destroy
...
type p_title from w_popup_root`p_title within w_des_bom_excel_form_default_popup
integer width = 4704
integer weight = 400
...
type cb_sort from w_popup_root`cb_sort within w_des_bom_excel_form_default_popup
integer x = 1024
integer y = 0
integer taborder = 40
end type

type cb_close from w_popup_root`cb_close within w_des_bom_excel_form_default_popup
...
type st_msg from w_popup_root`st_msg within w_des_bom_excel_form_default_popup
boolean visible = true
integer y = 800
integer width = 4704
integer weight = 400
...
type dw_1 from w_popup_root`dw_1 within w_des_bom_excel_form_default_popup
boolean visible = true
integer y = 908
integer width = 4709
integer height = 1664
...
string dataobject = "d_des_bom_import_excel_default"
boolean controlmenu = true
end type

type dw_2 from w_popup_root`dw_2 within w_des_bom_excel_form_default_popup
boolean visible = true
integer y = 920
integer width = 2007
integer height = 1692
...
type dw_3 from w_popup_root`dw_3 within w_des_bom_excel_form_default_popup
integer y = 916
integer taborder = 50
end type
