HA$PBExportHeader$w_des_bom_copy_with_shaft_popup.srw
forward
global type w_des_bom_copy_with_shaft_popup from w_popup_root
end type
type gb_2 from so_groupbox within w_des_bom_copy_with_shaft_popup
end type
type cb_1 from so_commandbutton within w_des_bom_copy_with_shaft_popup
end type
type st_source from so_statictext within w_des_bom_copy_with_shaft_popup
end type
type st_dest from so_statictext within w_des_bom_copy_with_shaft_popup
end type
type st_dest_line_code from so_statictext within w_des_bom_copy_with_shaft_popup
end type
type st_source_line_code from so_statictext within w_des_bom_copy_with_shaft_popup
end type
type ddlb_source_model from uo_model_name_ddlb within w_des_bom_copy_with_shaft_popup
end type
type ddlb_dest_model from uo_model_name_ddlb within w_des_bom_copy_with_shaft_popup
end type
type ddlb_dest_line_code from uo_line_code within w_des_bom_copy_with_shaft_popup
end type
type ddlb_source_line_code from uo_line_code within w_des_bom_copy_with_shaft_popup
end type
type cbx_replace_include from so_checkbox within w_des_bom_copy_with_shaft_popup
end type
type rb_top from so_radiobutton within w_des_bom_copy_with_shaft_popup
end type
type rb_bottom from so_radiobutton within w_des_bom_copy_with_shaft_popup
end type
end forward
...
global w_des_bom_copy_with_shaft_popup w_des_bom_copy_with_shaft_popup

on w_des_bom_copy_with_shaft_popup.create
int iCurrent
call super::create
...
on w_des_bom_copy_with_shaft_popup.destroy
call super::destroy
destroy(this.gb_2)
destroy(this.cb_1)
...
type p_title from w_popup_root`p_title within w_des_bom_copy_with_shaft_popup
integer width = 1947
end type

type cb_sort from w_popup_root`cb_sort within w_des_bom_copy_with_shaft_popup
integer x = 0
integer y = 1424
integer width = 320
integer height = 140
...
type cb_close from w_popup_root`cb_close within w_des_bom_copy_with_shaft_popup
...
type st_msg from w_popup_root`st_msg within w_des_bom_copy_with_shaft_popup
boolean visible = true
integer y = 200
integer width = 1947
end type

type dw_1 from w_popup_root`dw_1 within w_des_bom_copy_with_shaft_popup
boolean visible = true
integer y = 1424
integer taborder = 0
...
type dw_2 from w_popup_root`dw_2 within w_des_bom_copy_with_shaft_popup
boolean visible = true
integer y = 1424
integer taborder = 0
end type

type dw_3 from w_popup_root`dw_3 within w_des_bom_copy_with_shaft_popup
integer y = 1424
integer taborder = 80
end type
...
if isnull( ddlb_source_model.getcode()) then 	
...
if isnull( ddlb_dest_model.getcode()) then 
...
if   lvs_source_parent_item_code = lvs_dest_parent_item_code and lvs_source_line_code = lvs_dest_line_code and lvs_source_shaft = lvs_dest_shaft then 
	...
	return
     ...
     WHERE PARENT_ITEM_CODE =  :lvs_source_parent_item_code 
		...
		AND NVL(FEEDER_SHAFT,'*')  LIKE :lvs_source_shaft;
		...
		IF LVI_COUNT = 0 THEN 
			MESSAGEBOX('Notify' , lvs_source_line_code+  +lvs_source_parent_item_code+ f_msg('$$HEX10$$7cb920003ecc44c718c22000c6c5b5c2c8b2e4b2$$ENDHEX$$','S'))
			RETURN 
		END IF 
     ...
     WHERE PARENT_ITEM_CODE =  :lvs_dest_parent_item_code 
		...
		IF LVI_COUNT_EIXTIS > 0 THEN 
			MESSAGEBOX('Notify' , lvs_source_line_code+  +lvs_source_parent_item_code+ f_msg('$$HEX23$$74c7f8bb200074c8acc7200069d5c8b2e4b22000adc01cc8c4d62000e4b2dcc22000dcc2c4b3200058d538c194c6$$ENDHEX$$','S'))
			RETURN 
		END IF 		
