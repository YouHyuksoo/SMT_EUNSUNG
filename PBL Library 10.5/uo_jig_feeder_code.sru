HA$PBExportHeader$uo_jig_feeder_code.sru
$PBExportComments$Line ddlb Object
forward
global type uo_jig_feeder_code from dropdownlistbox
end type
end forward
...
global uo_jig_feeder_code uo_jig_feeder_code
...
on uo_jig_feeder_code.create
end on

on uo_jig_feeder_code.destroy
end on
