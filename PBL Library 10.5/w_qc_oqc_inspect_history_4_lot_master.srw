HA$PBExportHeader$w_qc_oqc_inspect_history_4_lot_master.srw
$PBExportComments$$$HEX17$$b9c278c7d0c658c7a8ba78b3d0c5200000b35cd52000b9d231c144c7200000adacb9$$ENDHEX$$
forward
global type w_qc_oqc_inspect_history_4_lot_master from w_main_root
end type
type sle_magazine_label from so_singlelineedit within w_qc_oqc_inspect_history_4_lot_master
end type
type st_1 from so_statictext within w_qc_oqc_inspect_history_4_lot_master
end type
type sle_model_name from so_singlelineedit within w_qc_oqc_inspect_history_4_lot_master
end type
type st_mrm_no from so_statictext within w_qc_oqc_inspect_history_4_lot_master
end type
type sle_inspector from so_singlelineedit within w_qc_oqc_inspect_history_4_lot_master
end type
type st_2 from so_statictext within w_qc_oqc_inspect_history_4_lot_master
end type
type sle_item_code from so_singlelineedit within w_qc_oqc_inspect_history_4_lot_master
end type
type st_7 from so_statictext within w_qc_oqc_inspect_history_4_lot_master
end type
type rb_manage from so_radiobutton within w_qc_oqc_inspect_history_4_lot_master
end type
type rb_2 from so_radiobutton within w_qc_oqc_inspect_history_4_lot_master
end type
type st_4 from so_statictext within w_qc_oqc_inspect_history_4_lot_master
end type
type uo_dateset from uo_ymd_calendar within w_qc_oqc_inspect_history_4_lot_master
end type
type uo_dateend from uo_ymd_calendar within w_qc_oqc_inspect_history_4_lot_master
end type
type rb_normal from so_radiobutton within w_qc_oqc_inspect_history_4_lot_master
end type
type rb_cancel from so_radiobutton within w_qc_oqc_inspect_history_4_lot_master
end type
type sle_magazine_label_cond from so_singlelineedit within w_qc_oqc_inspect_history_4_lot_master
end type
type st_5 from so_statictext within w_qc_oqc_inspect_history_4_lot_master
end type
type ddlb_workstage_code from uo_workstage_code_all within w_qc_oqc_inspect_history_4_lot_master
end type
type st_13 from so_statictext within w_qc_oqc_inspect_history_4_lot_master
end type
type gb_2 from so_groupbox within w_qc_oqc_inspect_history_4_lot_master
end type
type gb_3 from so_groupbox within w_qc_oqc_inspect_history_4_lot_master
end type
type gb_4 from so_groupbox within w_qc_oqc_inspect_history_4_lot_master
end type
type gb_5 from so_groupbox within w_qc_oqc_inspect_history_4_lot_master
end type
end forward
...
integer width = 6089
integer height = 2880
string title = "OQC Inspect History Master(LOT)"
string ivs_dw_2_selected_row_yn = "Y"
string ivs_dw_3_selected_row_yn = "Y"
sle_magazine_label sle_magazine_label
st_1 st_1
...
global w_qc_oqc_inspect_history_4_lot_master w_qc_oqc_inspect_history_4_lot_master
...
on w_qc_oqc_inspect_history_4_lot_master.create
int iCurrent
call super::create
this.sle_magazine_label=create sle_magazine_label
...
this.Control[iCurrent+1]=this.sle_magazine_label
...
this.Control[iCurrent+16]=this.sle_magazine_label_cond
this.Control[iCurrent+17]=this.st_5
this.Control[iCurrent+18]=this.ddlb_workstage_code
...
on w_qc_oqc_inspect_history_4_lot_master.destroy
call super::destroy
destroy(this.sle_magazine_label)
destroy(this.st_1)
...
event ue_data_control;call super::ue_data_control;choose case gvs_ue_data_control
	...
	case 'RETRIEVE'
		...
		if rb_manage.checked = true then 
			...
			dw_3.retrieve( uo_dateset.text() , uo_dateend.text() , 'L'+'%' , gvi_organization_id ,  sle_model_name.text + '%', sle_item_code.text+'%', sle_magazine_label_cond.text+'%' )
...
type dw_5 from w_main_root`dw_5 within w_qc_oqc_inspect_history_4_lot_master
integer y = 364
integer taborder = 0
end type

type dw_4 from w_main_root`dw_4 within w_qc_oqc_inspect_history_4_lot_master
integer y = 364
integer width = 5106
integer height = 2024
integer taborder = 0
...
type dw_3 from w_main_root`dw_3 within w_qc_oqc_inspect_history_4_lot_master
integer y = 364
integer width = 5106
integer height = 2024
integer taborder = 0
...
type dw_2 from w_main_root`dw_2 within w_qc_oqc_inspect_history_4_lot_master
integer y = 364
integer width = 5106
integer height = 2024
integer taborder = 0
...
type dw_1 from w_main_root`dw_1 within w_qc_oqc_inspect_history_4_lot_master
integer y = 364
integer width = 5106
integer height = 2024
integer taborder = 0
...
event dw_1::clicked;call super::clicked;sle_magazine_label.setfocus( )
end event

event dw_1::rowfocuschanged;call super::rowfocuschanged;if currentrow < 1 then return 
dw_2.retrieve( this.object.product_id[currentrow], gvi_organization_id )
end event

type uo_tabpages from w_main_root`uo_tabpages within w_qc_oqc_inspect_history_4_lot_master
integer taborder = 0
end type
...
event modified;call super::modified;string lvs_serial_no ,  lvs_line_code  , lvs_item_code , lvs_model_name , lvs_model_suffix , lvs_inspect_type, lvs_inspector
long lvl_sequence  , lvi_count , lvi_exists
...
if rb_normal.checked = true then 
			...
			lvs_inspect_type = 'L' //$$HEX15$$e4b970acc4c9200088bdc9b774c725b8200074c780b7200058c7f8bb2000$$ENDHEX$$pid $$HEX7$$88bdc9b774c72000bdacb0c62000$$ENDHEX$$p 
			...
			//==============================================
			// $$HEX20$$e4b970acc4c920002000c8b9a4c230d15cb8200080bd45d1200015c8f4bc200000ac38c834c62000$$ENDHEX$$
			//==============================================
			lvi_exists = 0 
			select  1 ,  item_code, model_name, model_suffix 
				 INTO  :lvi_exists , :lvs_item_code  , :LVS_MODEL_NAME , :lvs_model_suffix
			...
			IF lvi_exists = 0  THEN 
					...
					f_msg("Not Found Magazine Information",'P') 
					return 
			END IF 
...
//===================================================
	...
	f_msg('$$HEX8$$e8cd8cc1200018b4c8c5b5c2c8b2e4b2$$ENDHEX$$' , 'P' ) 	
