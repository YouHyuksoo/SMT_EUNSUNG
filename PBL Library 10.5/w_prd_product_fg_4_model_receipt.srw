HA$PBExportHeader$w_prd_product_fg_4_model_receipt.srw
$PBExportComments$finish goods  $$HEX8$$a8ba78b3e8b204c7200085c7e0ac2000$$ENDHEX$$/ $$HEX6$$85c7e0ac2000e8cd8cc12000$$ENDHEX$$2017.03.29
forward
global type w_prd_product_fg_4_model_receipt from w_main_root
end type
type sle_receipt_qty from so_singlelineedit within w_prd_product_fg_4_model_receipt
end type
type st_2 from statictext within w_prd_product_fg_4_model_receipt
end type
type st_status from so_statictext within w_prd_product_fg_4_model_receipt
end type
type rb_receipt from so_radiobutton within w_prd_product_fg_4_model_receipt
end type
type rb_search from so_radiobutton within w_prd_product_fg_4_model_receipt
end type
type sle_s_pack from so_singlelineedit within w_prd_product_fg_4_model_receipt
end type
type sle_s_model from so_singlelineedit within w_prd_product_fg_4_model_receipt
end type
type st_5 from statictext within w_prd_product_fg_4_model_receipt
end type
type st_6 from statictext within w_prd_product_fg_4_model_receipt
end type
type rb_normal from so_radiobutton within w_prd_product_fg_4_model_receipt
end type
type rb_cancel from so_radiobutton within w_prd_product_fg_4_model_receipt
end type
type uo_dateset from uo_ymd_calendar within w_prd_product_fg_4_model_receipt
end type
type uo_dateend from uo_ymd_calendar within w_prd_product_fg_4_model_receipt
end type
type st_7 from statictext within w_prd_product_fg_4_model_receipt
end type
type cbx_sound_on from so_checkbox within w_prd_product_fg_4_model_receipt
end type
type ddlb_line_code from uo_line_code_dd within w_prd_product_fg_4_model_receipt
end type
type ddlb_workstage_code from uo_workstage_code_all within w_prd_product_fg_4_model_receipt
end type
type st_8 from statictext within w_prd_product_fg_4_model_receipt
end type
type st_9 from statictext within w_prd_product_fg_4_model_receipt
end type
type ddlb_product_location from uo_basecode within w_prd_product_fg_4_model_receipt
end type
type st_10 from statictext within w_prd_product_fg_4_model_receipt
end type
type ddlb_txn_deficit from uo_basecode within w_prd_product_fg_4_model_receipt
end type
type st_1 from statictext within w_prd_product_fg_4_model_receipt
end type
type ddlb_model_name from uo_set_model_name_ddlb within w_prd_product_fg_4_model_receipt
end type
type st_3 from statictext within w_prd_product_fg_4_model_receipt
end type
type cb_manpack from so_commandbutton within w_prd_product_fg_4_model_receipt
end type
type gb_1 from so_groupbox within w_prd_product_fg_4_model_receipt
end type
type gb_2 from so_groupbox within w_prd_product_fg_4_model_receipt
end type
type gb_3 from so_groupbox within w_prd_product_fg_4_model_receipt
end type
type gb_5 from so_groupbox within w_prd_product_fg_4_model_receipt
end type
type gb_4 from so_groupbox within w_prd_product_fg_4_model_receipt
end type
type gb_6 from so_groupbox within w_prd_product_fg_4_model_receipt
end type
type gb_7 from so_groupbox within w_prd_product_fg_4_model_receipt
end type
end forward
...
integer width = 4928
integer height = 2380
string title = "Product Magazine Receipt Master"
...
global w_prd_product_fg_4_model_receipt w_prd_product_fg_4_model_receipt
...
on w_prd_product_fg_4_model_receipt.create
int iCurrent
call super::create
...
this.Control[iCurrent+1]=this.sle_receipt_qty
...
this.Control[iCurrent+26]=this.cb_manpack
...
on w_prd_product_fg_4_model_receipt.destroy
call super::destroy
...
type dw_5 from w_main_root`dw_5 within w_prd_product_fg_4_model_receipt
integer x = 110
integer y = 1120
integer width = 219
integer height = 128
...
type dw_4 from w_main_root`dw_4 within w_prd_product_fg_4_model_receipt
integer x = 73
integer y = 1088
integer width = 206
integer height = 144
...
type dw_3 from w_main_root`dw_3 within w_prd_product_fg_4_model_receipt
integer x = 73
integer y = 1120
integer width = 1298
integer height = 348
...
type dw_2 from w_main_root`dw_2 within w_prd_product_fg_4_model_receipt
integer x = 2798
integer y = 700
integer width = 2034
integer height = 1572
...
type dw_1 from w_main_root`dw_1 within w_prd_product_fg_4_model_receipt
integer x = 9
integer y = 700
integer width = 2775
integer height = 1116
...
type uo_tabpages from w_main_root`uo_tabpages within w_prd_product_fg_4_model_receipt
integer taborder = 0
end type
...
st_status.text = f_msg('$$HEX14$$85c7e0ac60d52000a8ba78b344c7200020c1ddd0200058d538c194c6$$ENDHEX$$','S')
...
event clicked;call super::clicked;    ddlb_model_name.enabled = false 
    ddlb_product_location.enabled = false 
    sle_receipt_qty.enabled = false 
...
event clicked;call super::clicked;sle_receipt_qty.textColor  = RGB(0,255,0)
sle_receipt_qty.backColor = RGB(0,0,0)

st_status.text = f_msg('$$HEX17$$85c7e0ac98ccacb9200060d52000a8ba78b344c7200020c1ddd0200058d538c194c6$$ENDHEX$$','S')
...
event clicked;call super::clicked;sle_receipt_qty.textColor = RGB(255,255,255)
sle_receipt_qty.backColor = RGB(255,0,0)

st_status.text = f_msg('$$HEX17$$85c7e0ac2000e8cd8cc160d52000a8ba78b344c72000a4c294ce200058d538c194c6$$ENDHEX$$','S')
...
event clicked;call super::clicked;//Unpack $$HEX3$$7cc74cb52000$$ENDHEX$$
//=================================================
string lvs_out , lvs_outmsg, lvs_barcode, lvs_location, lvs_commit ,  lvs_model_name , lvs_item_code, lvs_receipt_qty
long lvl_txn_type, lvl_row
long lvl_count , lvl_lot_qty, lvl_receipt_qty
string lvs_runno 
...
lvs_receipt_qty    = sle_receipt_qty.text 

if  lvs_receipt_qty = '' or  lvs_receipt_qty = '0' or isnumber(lvs_receipt_qty) = false then 
	sle_receipt_qty.text = ''
	sle_receipt_qty.setfocus( )
	return 
end if 
...
//=====================================================
declare proc procedure for P_PRODUCT_FG_MODEL_RECEIPT ( :lvs_barcode ,  :lvs_receipt_qty, :lvs_location, :lvl_txn_type, :lvs_commit   ) 
using sqlca ; 
