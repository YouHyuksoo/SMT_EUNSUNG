HA$PBExportHeader$uo_machine_code.sru
$PBExportComments$Line ddlb Object
forward
global type uo_machine_code from dropdownlistbox
end type
end forward
...
global uo_machine_code uo_machine_code
...
on uo_machine_code.create
end on

on uo_machine_code.destroy
end on
