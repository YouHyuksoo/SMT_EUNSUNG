HA$PBExportHeader$w_mat_baking_dehumi_scan_query.srw
forward
global type w_mat_baking_dehumi_scan_query from w_main_root
end type
type st_11 from so_statictext within w_mat_baking_dehumi_scan_query
end type
type sle_our_barcode from so_singlelineedit within w_mat_baking_dehumi_scan_query
end type
type st_1 from so_statictext within w_mat_baking_dehumi_scan_query
end type
type ddlb_item_code from uo_item_code within w_mat_baking_dehumi_scan_query
end type
type sle_material_mfs from so_singlelineedit within w_mat_baking_dehumi_scan_query
end type
type st_2 from so_statictext within w_mat_baking_dehumi_scan_query
end type
type sle_chamber_code from so_singlelineedit within w_mat_baking_dehumi_scan_query
end type
type st_chamber_code from so_statictext within w_mat_baking_dehumi_scan_query
end type
type rb_backing from so_radiobutton within w_mat_baking_dehumi_scan_query
end type
type rb_dehumi from so_radiobutton within w_mat_baking_dehumi_scan_query
end type
type rb_vacuum from so_radiobutton within w_mat_baking_dehumi_scan_query
end type
type gb_1 from so_groupbox within w_mat_baking_dehumi_scan_query
end type
type gb_6 from so_groupbox within w_mat_baking_dehumi_scan_query
end type
end forward
...
integer width = 6647
integer height = 2748
string title = "Baking Stock Query"
...
global w_mat_baking_dehumi_scan_query w_mat_baking_dehumi_scan_query
...
on w_mat_baking_dehumi_scan_query.create
int iCurrent
call super::create
...
on w_mat_baking_dehumi_scan_query.destroy
call super::destroy
destroy(this.st_11)
...
type dw_5 from w_main_root`dw_5 within w_mat_baking_dehumi_scan_query
integer y = 316
end type

type dw_4 from w_main_root`dw_4 within w_mat_baking_dehumi_scan_query
integer y = 316
end type

type dw_3 from w_main_root`dw_3 within w_mat_baking_dehumi_scan_query
integer y = 316
integer width = 4366
integer height = 872
end type

type dw_2 from w_main_root`dw_2 within w_mat_baking_dehumi_scan_query
integer y = 1324
integer width = 4370
integer height = 1284
boolean titlebar = true
string title = "Chamber Detail"
string dataobject = "d_mat_material_baking_dehumi_query_lst"
end type

type dw_1 from w_main_root`dw_1 within w_mat_baking_dehumi_scan_query
integer y = 312
integer width = 4375
integer height = 1004
boolean titlebar = true
...
type uo_tabpages from w_main_root`uo_tabpages within w_mat_baking_dehumi_scan_query
end type
