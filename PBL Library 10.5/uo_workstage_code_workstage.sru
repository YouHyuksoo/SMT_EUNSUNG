HA$PBExportHeader$uo_workstage_code_workstage.sru
$PBExportComments$Line ddlb Object
forward
global type uo_workstage_code_workstage from dropdownlistbox
end type
end forward
...
global uo_workstage_code_workstage uo_workstage_code_workstage
...
DECLARE CUR_01 CURSOR FOR 
	SELECT WORKSTAGE_CODE, WORKSTAGE_NAME
	 ...
	 WHERE WORKSTAGE_START_YN = 'N'
		 AND WORKSTAGE_TYPE <>  'L'
...
on uo_workstage_code_workstage.create
end on

on uo_workstage_code_workstage.destroy
end on
