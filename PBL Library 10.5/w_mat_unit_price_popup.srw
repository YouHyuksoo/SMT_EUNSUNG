HA$PBExportHeader$w_mat_unit_price_popup.srw
$PBExportComments$$$HEX8$$6cade4b9e8b200ac20c1ddd01dd3c5c5$$ENDHEX$$
forward
global type w_mat_unit_price_popup from w_popup_root
end type
type cb_retrieve from commandbutton within w_mat_unit_price_popup
end type
type cb_select from commandbutton within w_mat_unit_price_popup
end type
type ddlb_supplier_code from uo_supplier_code within w_mat_unit_price_popup
end type
type st_4 from statictext within w_mat_unit_price_popup
end type
type st_5 from statictext within w_mat_unit_price_popup
end type
type uo_item from uo_item_code within w_mat_unit_price_popup
end type
type st_1 from statictext within w_mat_unit_price_popup
end type
type uo_dateset from uo_ymd_calendar within w_mat_unit_price_popup
end type
type st_14 from so_statictext within w_mat_unit_price_popup
end type
type sle_item_spec from so_singlelineedit within w_mat_unit_price_popup
end type
type ddlb_line_type from uo_line_type within w_mat_unit_price_popup
end type
type st_2 from statictext within w_mat_unit_price_popup
end type
type rb_6 from so_radiobutton within w_mat_unit_price_popup
end type
type rb_5 from so_radiobutton within w_mat_unit_price_popup
end type
type rb_4 from so_radiobutton within w_mat_unit_price_popup
end type
type cbx_show_all from so_checkbox within w_mat_unit_price_popup
end type
type gb_1 from so_groupbox within w_mat_unit_price_popup
end type
type gb_2 from so_groupbox within w_mat_unit_price_popup
end type
type gb_4 from so_groupbox within w_mat_unit_price_popup
end type
end forward
...
on w_mat_unit_price_popup.destroy
call super::destroy
...
type p_title from w_popup_root`p_title within w_mat_unit_price_popup
integer x = 18
integer width = 3881
end type

type cb_sort from w_popup_root`cb_sort within w_mat_unit_price_popup
...
type cb_close from w_popup_root`cb_close within w_mat_unit_price_popup
boolean visible = true
integer x = 3392
integer y = 288
integer taborder = 70
...
type st_msg from w_popup_root`st_msg within w_mat_unit_price_popup
boolean visible = true
integer y = 488
integer width = 3881
end type

type dw_1 from w_popup_root`dw_1 within w_mat_unit_price_popup
boolean visible = true
integer y = 792
integer width = 3881
integer height = 1256
...
string dataobject = "d_mat_unit_price_popup"
boolean maxbox = true
end type
...
type dw_2 from w_popup_root`dw_2 within w_mat_unit_price_popup
boolean visible = true
integer y = 792
integer taborder = 0
end type

type dw_3 from w_popup_root`dw_3 within w_mat_unit_price_popup
integer y = 792
end type
