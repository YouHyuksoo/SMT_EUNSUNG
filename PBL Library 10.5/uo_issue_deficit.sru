HA$PBExportHeader$uo_issue_deficit.sru
$PBExportComments$Item Type
forward
global type uo_issue_deficit from dropdownlistbox
end type
end forward
...
global uo_issue_deficit uo_issue_deficit
...
on uo_issue_deficit.create
end on

on uo_issue_deficit.destroy
end on
