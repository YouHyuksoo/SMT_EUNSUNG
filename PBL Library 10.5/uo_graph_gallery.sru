HA$PBExportHeader$uo_graph_gallery.sru
$PBExportComments$Gallery of graph types
forward
global type uo_graph_gallery from userobject
end type
type p_gallery from picture within uo_graph_gallery
end type
type st_1 from statictext within uo_graph_gallery
end type
type cb_ok from commandbutton within uo_graph_gallery
end type
type cb_cancel from commandbutton within uo_graph_gallery
end type
type mle_1 from multilineedit within uo_graph_gallery
end type
end forward
...
event gallery_clicked pbm_custom03
p_gallery p_gallery
st_1 st_1
cb_ok cb_ok
cb_cancel cb_cancel
...
global uo_graph_gallery uo_graph_gallery
...
integer width = 1792
integer height = 992
string picturename = "gallary.bmp"
end type
...
Parent.TriggerEvent ("gallery_clicked")
end event
