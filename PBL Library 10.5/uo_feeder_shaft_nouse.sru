HA$PBExportHeader$uo_feeder_shaft_nouse.sru
forward
global type uo_feeder_shaft_nouse from dropdownlistbox
end type
type st_vendor from structure within uo_feeder_shaft_nouse
end type
end forward
...
global uo_feeder_shaft_nouse uo_feeder_shaft_nouse
...
SELECT CODE_NAME  FROM ISYS_BASECODE 
WHERE CODE_TYPE = 'FEEDER SHAFT'
...
on uo_feeder_shaft_nouse.create
end on

on uo_feeder_shaft_nouse.destroy
end on
