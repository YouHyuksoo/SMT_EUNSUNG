HA$PBExportHeader$w_mat_mass_issue_master.srw
$PBExportComments$Material Mass Issue Master
forward
global type w_mat_mass_issue_master from w_main_root
end type
type uo_dateset from uo_ymd_calendar within w_mat_mass_issue_master
end type
type uo_dateend from uo_ymd_calendar within w_mat_mass_issue_master
end type
type ddlb_item_code from uo_item_code within w_mat_mass_issue_master
end type
type st_3 from so_statictext within w_mat_mass_issue_master
end type
type st_4 from so_statictext within w_mat_mass_issue_master
end type
type rb_workorder from so_radiobutton within w_mat_mass_issue_master
end type
type rb_issue from so_radiobutton within w_mat_mass_issue_master
end type
type st_14 from so_statictext within w_mat_mass_issue_master
end type
type sle_item_name from so_singlelineedit within w_mat_mass_issue_master
end type
type st_5 from so_statictext within w_mat_mass_issue_master
end type
type st_1 from so_statictext within w_mat_mass_issue_master
end type
type ddlb_workstage_code from uo_workstage_code_all within w_mat_mass_issue_master
end type
type ddlb_set_item_code from uo_item_code within w_mat_mass_issue_master
end type
type st_7 from so_statictext within w_mat_mass_issue_master
end type
type tab_1 from tab within w_mat_mass_issue_master
end type
type tabpage_1 from userobject within tab_1
end type
type pb_replace from so_commandbutton within tabpage_1
end type
...
type cbx_group_issue from so_checkbox within tabpage_1
end type
...
type tabpage_1 from userobject within tab_1
pb_replace pb_replace
cb_1 cb_1
cbx_auto_save cbx_auto_save
cb_set cb_set
cbx_group_issue cbx_group_issue
ddlb_takeover_by ddlb_takeover_by
st_6 st_6
end type
type tabpage_2 from userobject within tab_1
end type
type cbx_by_invoice from so_checkbox within tabpage_2
end type
...
type sle_mfs from so_singlelineedit within w_mat_mass_issue_master
end type
type ddlb_line_code from uo_line_code within w_mat_mass_issue_master
end type
type st_8 from so_statictext within w_mat_mass_issue_master
end type
type gb_1 from so_groupbox within w_mat_mass_issue_master
end type
type gb_2 from so_groupbox within w_mat_mass_issue_master
end type
end forward
...
global w_mat_mass_issue_master w_mat_mass_issue_master

type variables
string ivs_preview_yn = 'N'
end variables

on w_mat_mass_issue_master.create
int iCurrent
call super::create
...
this.Control[iCurrent+13]=this.ddlb_set_item_code
this.Control[iCurrent+14]=this.st_7
this.Control[iCurrent+15]=this.tab_1
this.Control[iCurrent+16]=this.sle_mfs
...
on w_mat_mass_issue_master.destroy
call super::destroy
...
choose case gvs_ue_data_control
	...
	case 'RETRIEVE'
			...
			if    rb_workorder.checked = true  then 				
			    dw_1.retrieve( uo_dateset.text() , uo_dateend.text(),  ddlb_set_item_code.text()+'%',  SLE_MFS.text+'%' , ddlb_workstage_code.getcode()+'%' , ddlb_item_code.text() + '%',  ddlb_line_code.getcode()+'%' ,  gvi_organization_id)
			else
				dw_4.retrieve( uo_dateset.text() , uo_dateend.text(),  SLE_MFS.text+'%' , ddlb_workstage_code.getcode()+'%' , ddlb_item_code.text() + '%',   '%' , gvi_organization_id)
			end if 
...
type dw_5 from w_main_root`dw_5 within w_mat_mass_issue_master
integer y = 580
integer width = 4544
integer height = 1300
integer taborder = 0
...
type dw_4 from w_main_root`dw_4 within w_mat_mass_issue_master
integer y = 580
integer width = 4544
integer height = 1300
integer taborder = 0
...
type dw_3 from w_main_root`dw_3 within w_mat_mass_issue_master
integer x = 2272
integer y = 1888
integer width = 2267
integer height = 612
...
type dw_2 from w_main_root`dw_2 within w_mat_mass_issue_master
integer y = 1888
integer width = 2267
integer height = 612
integer taborder = 0
...
type dw_1 from w_main_root`dw_1 within w_mat_mass_issue_master
integer y = 580
integer width = 4544
integer height = 1300
integer taborder = 0
...
event dw_1::itemchanged;call super::itemchanged;string lvs_return , lvs_origanal_item_code
if dwo.name = 'item_code' then    
...
if dwo.name = 'remain_qty' then
	if data = '0' or isnull(data) then
		dw_1.object.check_yn[row] = 'N'
	else
		dw_1.object.check_yn[row] = 'Y'
	end if
end if
end event

type uo_tabpages from w_main_root`uo_tabpages within w_mat_mass_issue_master
end type
...
on tabpage_1.create
this.pb_replace=create pb_replace
this.cb_1=create cb_1
this.cbx_auto_save=create cbx_auto_save
this.cb_set=create cb_set
this.cbx_group_issue=create cbx_group_issue
this.ddlb_takeover_by=create ddlb_takeover_by
this.st_6=create st_6
this.Control[]={this.pb_replace,&
this.cb_1,&
this.cbx_auto_save,&
this.cb_set,&
this.cbx_group_issue,&
this.ddlb_takeover_by,&
this.st_6}
end on

on tabpage_1.destroy
destroy(this.pb_replace)
destroy(this.cb_1)
destroy(this.cbx_auto_save)
destroy(this.cb_set)
destroy(this.cbx_group_issue)
...
lvs_item_code = dw_1.getitemstring( dw_1.getrow() , 'original_item_code' )
if lvs_item_code = '' or isnull(lvs_item_code) then return

openwithparm( w_des_bom_replace_select_popup , lvs_item_code )

if Gst_return.gvb_return = true then 
	dw_1.object.item_code[dw_1.getrow()] = message.stringparm
end if 
end event
...
integer height = 100
integer taborder = 60
string text = "Show Order"
end type

event clicked;call super::clicked;openwithparm( w_mat_item_purchase_order_popup , string(dw_1.object.item_code[dw_1.getrow() ] ))
end event
...
String Lvs_made_by , lvs_location_code
...
//
//==================================================
if   tab_1.tabpage_1.cbx_group_issue.checked = true then 
...
for i = 1 to dw_1.rowcount()
	...
	if dw_1.object.check_yn[i] =  'Y' and  Dec(dw_1.object.inventory_qty[i])  > 0 and Dec(dw_1.object.remain_qty[i])  > 0  then 
	else 
		continue 
	end if 	

	//================================================
	// $$HEX10$$89d5c0bcbdac200074c7a4bcb8d2200038d69ccd$$ENDHEX$$
	// $$HEX32$$89d5c0bcbdacdcc2200090c7acc7acc7e0ac200015c8f4bc200090c7d9b3200070c88cd620000fbc200090c7d9b32000b4cc6cd020c1ddd0200098ccacb92000$$ENDHEX$$
	// $$HEX19$$b4cc6cd01cb42000acc7e0acccb920009ccde0ac18b4c0bb5cb82000b4cc6cd098ccacb968d5$$ENDHEX$$
	//================================================	
	
	if   cbx_group_issue.checked = true then 
		...
		//=============================================				
			  lvf_inventory_qty =  f_get_item_inventory_sum_qty(  dw_1.object.item_code[i]	 , dw_1.object.line_type[i] )
				 
				if lvf_inventory_qty <= 0 then 
						  if cbx_group_issue.checked = true then 
							// $$HEX19$$6cadf9b89ccde0ac7cc7bdacb0c6200034bbdcc2200058d5e0ac2000c4ac8dc12000c4c989d5$$ENDHEX$$
							continue
						  else
	...
	lvf_remain_qty = Dec(dw_1.object.remain_qty[i])
	...
	do
		...
		k++
		  ...
		  if cbx_group_issue.checked = true then 
					...
					lvs_location_code= dw_3.object.location_code[k]
		...
		if Truncate(lvf_inventory_qty,8)  < truncate(lvf_remain_qty,8) then 
				...
				dw_2.object.work_order_no[n] =dw_1.object.work_order_no[i]
				
				dw_2.object.item_code[n] = dw_1.object.item_code[i]	
				dw_2.object.parent_item_code[n] = dw_1.object.parent_item_code[i]		
				...
				//==================================================
				// $$HEX22$$b8d2acb970acd0c5200058c774d52000acc7e0ac200015c8f4bc200028cc10acdcc22000acc0a9c668d52000$$ENDHEX$$.
				//==================================================				
...
event clicked;call super::clicked;string lvs_invoice_no
...
SETPOINTER(HOURGLASS!)
	if  ivs_preview_yn = 'Y' THEN 
		...
		if cbx_by_invoice.checked = true then 
			lvs_invoice_no = dw_4.object.invoice_no[dw_4.getrow()]
			if isnull(lvs_invoice_no) then 
				lvs_invoice_no = '%'
			end if 
		else
			lvs_invoice_no = '%'
		...
		dw_5.retrieve( dw_4.object.mfs[dw_4.getrow()] , lvs_invoice_no ,  'N' , Gvi_organization_id )
