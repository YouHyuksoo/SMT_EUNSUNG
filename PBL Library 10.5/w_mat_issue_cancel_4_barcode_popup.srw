HA$PBExportHeader$w_mat_issue_cancel_4_barcode_popup.srw
$PBExportComments$Purchase Order Lot Divide Popup
forward
global type w_mat_issue_cancel_4_barcode_popup from w_none_dw_popup_root
end type
type st_origin from so_statictext within w_mat_issue_cancel_4_barcode_popup
end type
type sle_our_barcode from so_singlelineedit within w_mat_issue_cancel_4_barcode_popup
end type
type mle_log from multilineedit within w_mat_issue_cancel_4_barcode_popup
end type
type st_status from statictext within w_mat_issue_cancel_4_barcode_popup
end type
type st_1 from statictext within w_mat_issue_cancel_4_barcode_popup
end type
type em_count from so_editmask within w_mat_issue_cancel_4_barcode_popup
end type
type gb_1 from so_groupbox within w_mat_issue_cancel_4_barcode_popup
end type
end forward
...
global w_mat_issue_cancel_4_barcode_popup w_mat_issue_cancel_4_barcode_popup

on w_mat_issue_cancel_4_barcode_popup.create
int iCurrent
call super::create
...
on w_mat_issue_cancel_4_barcode_popup.destroy
call super::destroy
...
type p_title from w_none_dw_popup_root`p_title within w_mat_issue_cancel_4_barcode_popup
integer width = 3232
end type

type cb_close from w_none_dw_popup_root`cb_close within w_mat_issue_cancel_4_barcode_popup
...
type st_msg from w_none_dw_popup_root`st_msg within w_mat_issue_cancel_4_barcode_popup
boolean visible = true
integer y = 0
end type
...
lvs_our_barcode = Trim(sle_our_barcode.text) 
//
...
//==========================================================
	update im_item_receipt_barcode 
	     set issue_compare_yn = 'N'  , issue_compare_date = null , issue_return_yn = 'Y'
	 where  item_code               = :lvs_item_code
	    and lot_no                   =  :lvs_lot_no
		and issue_compare_yn = 'Y'
		and organization_id        = :gvi_organization_id ;
