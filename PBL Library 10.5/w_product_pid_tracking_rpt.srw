HA$PBExportHeader$w_product_pid_tracking_rpt.srw
$PBExportComments$new a led project
forward
global type w_product_pid_tracking_rpt from w_main_root
end type
type sle_lot_no from so_singlelineedit within w_product_pid_tracking_rpt
end type
type st_1 from statictext within w_product_pid_tracking_rpt
end type
type gb_2 from so_groupbox within w_product_pid_tracking_rpt
end type
end forward
...
global w_product_pid_tracking_rpt w_product_pid_tracking_rpt

type variables

end variables

on w_product_pid_tracking_rpt.create
int iCurrent
call super::create
...
on w_product_pid_tracking_rpt.destroy
call super::destroy
...
type dw_5 from w_main_root`dw_5 within w_product_pid_tracking_rpt
integer y = 392
end type

type dw_4 from w_main_root`dw_4 within w_product_pid_tracking_rpt
integer y = 392
boolean titlebar = true
end type

type dw_3 from w_main_root`dw_3 within w_product_pid_tracking_rpt
integer y = 392
boolean titlebar = true
...
type dw_2 from w_main_root`dw_2 within w_product_pid_tracking_rpt
integer x = 2491
integer y = 372
integer width = 2048
integer height = 1356
...
type dw_1 from w_main_root`dw_1 within w_product_pid_tracking_rpt
integer y = 372
integer width = 2482
integer height = 1356
boolean titlebar = true
...
DW_2.RETRIEVE(  string(this.object.check_Date_start[currentrow] , 'YYYY/MM/DD HH:MM:SS') , string( this.object.check_Date_end[currentrow] , 'YYYY/MM/DD HH:MM:SS' ) ,    lvsa_line_code , gvi_organization_id )
end event

type uo_tabpages from w_main_root`uo_tabpages within w_product_pid_tracking_rpt
end type
