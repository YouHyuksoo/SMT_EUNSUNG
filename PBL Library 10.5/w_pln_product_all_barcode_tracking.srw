HA$PBExportHeader$w_pln_product_all_barcode_tracking.srw
$PBExportComments$Line Master
forward
global type w_pln_product_all_barcode_tracking from w_main_root
end type
type st_mrm_no from statictext within w_pln_product_all_barcode_tracking
end type
type sle_run_no from so_singlelineedit within w_pln_product_all_barcode_tracking
end type
type sle_pcb_serial_no from so_singlelineedit within w_pln_product_all_barcode_tracking
end type
type st_2 from statictext within w_pln_product_all_barcode_tracking
end type
type uo_dateset from uo_ymd_calendar within w_pln_product_all_barcode_tracking
end type
type st_4 from so_statictext within w_pln_product_all_barcode_tracking
end type
type uo_dateend from uo_ymd_calendar within w_pln_product_all_barcode_tracking
end type
type ddlb_model_name from uo_set_model_name_ddlb within w_pln_product_all_barcode_tracking
end type
type st_1 from statictext within w_pln_product_all_barcode_tracking
end type
type ddlb_line_code from uo_line_code within w_pln_product_all_barcode_tracking
end type
type st_3 from statictext within w_pln_product_all_barcode_tracking
end type
type gb_1 from so_groupbox within w_pln_product_all_barcode_tracking
end type
end forward
...
global w_pln_product_all_barcode_tracking w_pln_product_all_barcode_tracking
...
on w_pln_product_all_barcode_tracking.create
int iCurrent
call super::create
...
on w_pln_product_all_barcode_tracking.destroy
call super::destroy
...
event resize;call super::resize;    dw_1.resize( dw_1.width -34 , height - ( dw_1.y +120)  )
...
type dw_5 from w_main_root`dw_5 within w_pln_product_all_barcode_tracking
integer y = 320
integer width = 782
integer height = 1932
integer taborder = 0
...
type dw_4 from w_main_root`dw_4 within w_pln_product_all_barcode_tracking
integer y = 320
integer width = 782
integer height = 1932
integer taborder = 0
...
type dw_3 from w_main_root`dw_3 within w_pln_product_all_barcode_tracking
integer x = 1627
integer y = 1448
integer width = 4206
integer height = 1000
...
string title = "Material Feeding List"
string dataobject = "d_ip_product_pid_inspect_data_mat_lst"
end type

type dw_2 from w_main_root`dw_2 within w_pln_product_all_barcode_tracking
integer x = 1623
integer y = 320
integer width = 4206
integer height = 1120
integer taborder = 0
boolean titlebar = true
string title = "Tracking List"
string dataobject = "d_pln_product_all_barcode_tracking_es"
end type
...
type dw_1 from w_main_root`dw_1 within w_pln_product_all_barcode_tracking
integer y = 320
integer width = 1614
integer height = 2140
integer taborder = 0
...
type uo_tabpages from w_main_root`uo_tabpages within w_pln_product_all_barcode_tracking
integer taborder = 0
end type
