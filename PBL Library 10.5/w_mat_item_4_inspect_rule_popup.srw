HA$PBExportHeader$w_mat_item_4_inspect_rule_popup.srw
$PBExportComments$$$HEX8$$6cade4b9e8b200ac20c1ddd01dd3c5c5$$ENDHEX$$
forward
global type w_mat_item_4_inspect_rule_popup from w_popup_root
end type
type cb_retrieve from so_commandbutton within w_mat_item_4_inspect_rule_popup
end type
type cb_select from so_commandbutton within w_mat_item_4_inspect_rule_popup
end type
type st_item_code from so_statictext within w_mat_item_4_inspect_rule_popup
end type
type st_3 from so_statictext within w_mat_item_4_inspect_rule_popup
end type
type st_1 from so_statictext within w_mat_item_4_inspect_rule_popup
end type
type ddlb_supplier_code from uo_supplier_code within w_mat_item_4_inspect_rule_popup
end type
type ddlb_item_code from uo_item_code within w_mat_item_4_inspect_rule_popup
end type
type uo_date from uo_ymd_calendar within w_mat_item_4_inspect_rule_popup
end type
type sle_item_spec from so_singlelineedit within w_mat_item_4_inspect_rule_popup
end type
type st_14 from so_statictext within w_mat_item_4_inspect_rule_popup
end type
type rb_all from so_radiobutton within w_mat_item_4_inspect_rule_popup
end type
type rb_2 from so_radiobutton within w_mat_item_4_inspect_rule_popup
end type
type rb_goods from so_radiobutton within w_mat_item_4_inspect_rule_popup
end type
type rb_1 from so_radiobutton within w_mat_item_4_inspect_rule_popup
end type
type rb_3 from so_radiobutton within w_mat_item_4_inspect_rule_popup
end type
type rb_4 from so_radiobutton within w_mat_item_4_inspect_rule_popup
end type
type cb_1 from so_commandbutton within w_mat_item_4_inspect_rule_popup
end type
type gb_1 from so_groupbox within w_mat_item_4_inspect_rule_popup
end type
type gb_2 from so_groupbox within w_mat_item_4_inspect_rule_popup
end type
type gb_3 from so_groupbox within w_mat_item_4_inspect_rule_popup
end type
end forward
...
global w_mat_item_4_inspect_rule_popup w_mat_item_4_inspect_rule_popup

on w_mat_item_4_inspect_rule_popup.create
int iCurrent
call super::create
...
on w_mat_item_4_inspect_rule_popup.destroy
call super::destroy
...
type p_title from w_popup_root`p_title within w_mat_item_4_inspect_rule_popup
integer width = 4128
end type

type cb_sort from w_popup_root`cb_sort within w_mat_item_4_inspect_rule_popup
boolean visible = true
integer x = 32
integer y = 2376
end type

type cb_close from w_popup_root`cb_close within w_mat_item_4_inspect_rule_popup
boolean visible = true
integer x = 3767
integer y = 356
end type
...
type st_msg from w_popup_root`st_msg within w_mat_item_4_inspect_rule_popup
boolean visible = true
integer x = 5
integer y = 556
integer width = 4128
...
type dw_1 from w_popup_root`dw_1 within w_mat_item_4_inspect_rule_popup
boolean visible = true
integer x = 5
integer y = 648
integer width = 4128
...
type dw_2 from w_popup_root`dw_2 within w_mat_item_4_inspect_rule_popup
integer y = 580
end type

type dw_3 from w_popup_root`dw_3 within w_mat_item_4_inspect_rule_popup
integer y = 668
end type
