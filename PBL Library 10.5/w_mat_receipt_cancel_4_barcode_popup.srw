HA$PBExportHeader$w_mat_receipt_cancel_4_barcode_popup.srw
$PBExportComments$Purchase Order Lot Divide Popup
forward
global type w_mat_receipt_cancel_4_barcode_popup from w_none_dw_popup_root
end type
type st_origin from so_statictext within w_mat_receipt_cancel_4_barcode_popup
end type
type sle_our_barcode from so_singlelineedit within w_mat_receipt_cancel_4_barcode_popup
end type
type mle_log from multilineedit within w_mat_receipt_cancel_4_barcode_popup
end type
type st_status from statictext within w_mat_receipt_cancel_4_barcode_popup
end type
type st_1 from statictext within w_mat_receipt_cancel_4_barcode_popup
end type
type em_count from so_editmask within w_mat_receipt_cancel_4_barcode_popup
end type
type gb_1 from so_groupbox within w_mat_receipt_cancel_4_barcode_popup
end type
end forward
...
global w_mat_receipt_cancel_4_barcode_popup w_mat_receipt_cancel_4_barcode_popup

on w_mat_receipt_cancel_4_barcode_popup.create
int iCurrent
call super::create
...
on w_mat_receipt_cancel_4_barcode_popup.destroy
call super::destroy
...
type p_title from w_none_dw_popup_root`p_title within w_mat_receipt_cancel_4_barcode_popup
integer width = 3232
end type

type cb_close from w_none_dw_popup_root`cb_close within w_mat_receipt_cancel_4_barcode_popup
...
type st_msg from w_none_dw_popup_root`st_msg within w_mat_receipt_cancel_4_barcode_popup
boolean visible = true
integer y = 0
end type
...
//=============================
// $$HEX18$$85c7e0ac1cb42000e8cd8cc11cb4200074c725b874c7200074c8acc7200058d574ba2000$$ENDHEX$$
//=============================
if lvi_count > 0 then 
...
//======================================================
			UPDATE im_item_receipt_barcode 
		   	     SET receipt_compare_yn = 'Y' , RETURN_YN = 'N'
			 where  item_code         = :lvs_item_code
	  			and lot_no = :lvs_lot_no 
				and receipt_compare_yn = 'N'
				and return_yn = 'Y'
				...
				if f_sql_check() < 0 then
					st_status.text = f_msg("$$HEX16$$85c7e0ac18bc88d474c72000e8cd8cc1200018b4c0c920004ac5b5c2c8b2e4b2$$ENDHEX$$",'S')
					sle_our_barcode.setfocus()
					sle_our_barcode.selecttext( 1,100)	
					return
				end if 
