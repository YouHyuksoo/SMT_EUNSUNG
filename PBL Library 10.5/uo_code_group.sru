HA$PBExportHeader$uo_code_group.sru
forward
global type uo_code_group from dropdownlistbox
end type
type st_vendor from structure within uo_code_group
end type
end forward
...
global uo_code_group uo_code_group
...
on uo_code_group.create
end on

on uo_code_group.destroy
end on
