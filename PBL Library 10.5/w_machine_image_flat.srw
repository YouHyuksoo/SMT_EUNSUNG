HA$PBExportHeader$w_machine_image_flat.srw
forward
global type w_machine_image_flat from window
end type
type pb_btn from so_picturebutton within w_machine_image_flat
end type
type st_item_code from so_statictext within w_machine_image_flat
end type
type p_image from so_picture within w_machine_image_flat
end type
end forward
...
global w_machine_image_flat w_machine_image_flat
...
if lvs_item_code = '' or isnull(lvs_item_code) then
 ...
 select count(*) 
   into :lvi_count
  from imcn_machine
where machine_code = :lvs_item_code
...
on w_machine_image_flat.create
...
on w_machine_image_flat.destroy
destroy(this.pb_btn)
