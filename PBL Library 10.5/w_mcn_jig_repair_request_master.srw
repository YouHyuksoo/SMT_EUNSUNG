HA$PBExportHeader$w_mcn_jig_repair_request_master.srw
$PBExportComments$Material Receipt Master
forward
global type w_mcn_jig_repair_request_master from w_main_root
end type
type uo_dateset from uo_ymd_calendar within w_mcn_jig_repair_request_master
end type
type uo_dateend from uo_ymd_calendar within w_mcn_jig_repair_request_master
end type
type st_3 from so_statictext within w_mcn_jig_repair_request_master
end type
type st_4 from so_statictext within w_mcn_jig_repair_request_master
end type
type sle_jig_code from so_singlelineedit within w_mcn_jig_repair_request_master
end type
type st_2 from so_statictext within w_mcn_jig_repair_request_master
end type
type sle_model_name from so_singlelineedit within w_mcn_jig_repair_request_master
end type
type sle_jig_spec from so_singlelineedit within w_mcn_jig_repair_request_master
end type
type st_5 from so_statictext within w_mcn_jig_repair_request_master
end type
type rb_jig_list from so_radiobutton within w_mcn_jig_repair_request_master
end type
type rb_jig_repair_history from so_radiobutton within w_mcn_jig_repair_request_master
end type
type st_7 from so_statictext within w_mcn_jig_repair_request_master
end type
type em_copy from so_editmask within w_mcn_jig_repair_request_master
end type
type cbx_dialog from so_checkbox within w_mcn_jig_repair_request_master
end type
type cb_preview from so_commandbutton within w_mcn_jig_repair_request_master
end type
type cb_print from so_commandbutton within w_mcn_jig_repair_request_master
end type
type cb_cancel from so_commandbutton within w_mcn_jig_repair_request_master
end type
type cb_request from so_commandbutton within w_mcn_jig_repair_request_master
end type
type ddlb_jig_type from uo_basecode within w_mcn_jig_repair_request_master
end type
type st_6 from so_statictext within w_mcn_jig_repair_request_master
end type
type gb_2 from so_groupbox within w_mcn_jig_repair_request_master
end type
type gb_3 from groupbox within w_mcn_jig_repair_request_master
end type
type gb_1 from so_groupbox within w_mcn_jig_repair_request_master
end type
type gb_4 from so_groupbox within w_mcn_jig_repair_request_master
end type
end forward
...
integer width = 4827
integer height = 3028
string title = "Jig Repair Request Master"
...
global w_mcn_jig_repair_request_master w_mcn_jig_repair_request_master

type variables
string ivs_preview_yn
end variables

on w_mcn_jig_repair_request_master.create
int iCurrent
call super::create
...
this.sle_jig_spec=create sle_jig_spec
...
this.Control[iCurrent+8]=this.sle_jig_spec
this.Control[iCurrent+9]=this.st_5
this.Control[iCurrent+10]=this.rb_jig_list
this.Control[iCurrent+11]=this.rb_jig_repair_history
this.Control[iCurrent+12]=this.st_7
this.Control[iCurrent+13]=this.em_copy
this.Control[iCurrent+14]=this.cbx_dialog
this.Control[iCurrent+15]=this.cb_preview
this.Control[iCurrent+16]=this.cb_print
this.Control[iCurrent+17]=this.cb_cancel
this.Control[iCurrent+18]=this.cb_request
this.Control[iCurrent+19]=this.ddlb_jig_type
...
on w_mcn_jig_repair_request_master.destroy
call super::destroy
...
choose case gvs_ue_data_control
	...
	case 'RETRIEVE'
			...
			if rb_jig_list.checked = true then 
				    dw_1.retrieve( ddlb_jig_type.getcode( )+'%' ,   sle_jig_code.text + '%',   gvi_organization_id)
			else
				   dw_3.retrieve(ddlb_jig_type.getcode( )+'%' , sle_jig_code.text + '%', uo_dateset.text() , uo_dateend.text() ,  gvi_organization_id)				
			end if 
...
type dw_5 from w_main_root`dw_5 within w_mcn_jig_repair_request_master
integer y = 524
end type

type dw_4 from w_main_root`dw_4 within w_mcn_jig_repair_request_master
integer y = 516
integer width = 4544
integer height = 928
...
type dw_3 from w_main_root`dw_3 within w_mcn_jig_repair_request_master
integer y = 516
integer width = 4544
integer height = 928
boolean titlebar = true
...
type dw_2 from w_main_root`dw_2 within w_mcn_jig_repair_request_master
integer y = 1460
integer width = 4549
integer height = 632
boolean titlebar = true
string title = "JIG Repair List"
string dataobject = "d_mcn_jig_repair_request_lst"
...
type dw_1 from w_main_root`dw_1 within w_mcn_jig_repair_request_master
integer y = 516
integer width = 4544
integer height = 928
boolean titlebar = true
string title = "JIG List"
string dataobject = "d_mcn_jig_inventory_4_repair_lst"
end type

type uo_tabpages from w_main_root`uo_tabpages within w_mcn_jig_repair_request_master
end type
...
boolean bringtotop = true
integer weight = 700
string text = "Jig Repair History"
end type
