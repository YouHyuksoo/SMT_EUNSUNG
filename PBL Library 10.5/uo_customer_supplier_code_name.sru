HA$PBExportHeader$uo_customer_supplier_code_name.sru
forward
global type uo_customer_supplier_code_name from dropdownlistbox
end type
end forward
...
global uo_customer_supplier_code_name uo_customer_supplier_code_name
...
on uo_customer_supplier_code_name.create
end on

on uo_customer_supplier_code_name.destroy
end on
...
OPEN CUR_01 ;
	...
	IF F_SQL_CHECK_WITH_MSG('OPEN FROM ICOM_CUSTOMER/ICOM_SUPPLIER') < 0 THEN 
		CLOSE CUR_01 ;
		RETURN
	END IF	
