HA$PBExportHeader$uo_workstage_code_by_line.sru
$PBExportComments$Line ddlb Object
forward
global type uo_workstage_code_by_line from dropdownlistbox
end type
end forward
...
global uo_workstage_code_by_line uo_workstage_code_by_line
...
on uo_workstage_code_by_line.create
end on

on uo_workstage_code_by_line.destroy
end on
