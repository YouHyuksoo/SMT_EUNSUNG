HA$PBExportHeader$w_spi_time_query.srw
$PBExportComments$spi_time_query
forward
global type w_spi_time_query from w_main_root
end type
type st_label from so_statictext within w_spi_time_query
end type
type st_1 from so_statictext within w_spi_time_query
end type
type sle_pid from singlelineedit within w_spi_time_query
end type
type ddlb_line_code from uo_line_code within w_spi_time_query
end type
type st_2 from so_statictext within w_spi_time_query
end type
type st_4 from so_statictext within w_spi_time_query
end type
type uo_dateset from uo_ymd_calendar within w_spi_time_query
end type
type uo_dateend from uo_ymd_calendar within w_spi_time_query
end type
type st_3 from so_statictext within w_spi_time_query
end type
type sle_model_name from singlelineedit within w_spi_time_query
end type
type st_5 from so_statictext within w_spi_time_query
end type
type sle_run_no from singlelineedit within w_spi_time_query
end type
type gb_3 from so_groupbox within w_spi_time_query
end type
end forward
...
global w_spi_time_query w_spi_time_query
...
this.Control[iCurrent+3]=this.sle_pid
...
* REPORT ( Report )
****************************************/
F_MENU_CONTROL('DATA_CONTROL' ,TRUE)  // All Data Control   -- REPORT >> DATA_CONTROL
...
choose case gvs_ue_data_control
    ...
    CASE 'DELETE'
			...
			if msg = 1 then
				...
				delete iq_machine_inspect_data_spi where pid = :lvs_pid and rowid = CHARTOROWID(:lvs_rowid) ;
				commit;
...
type dw_5 from w_main_root`dw_5 within w_spi_time_query
integer y = 340
integer width = 4242
integer height = 1040
integer taborder = 0
...
type dw_4 from w_main_root`dw_4 within w_spi_time_query
integer y = 340
integer width = 4242
integer height = 1040
integer taborder = 0
...
type dw_3 from w_main_root`dw_3 within w_spi_time_query
integer y = 340
integer width = 4238
integer height = 1040
integer taborder = 0
...
type dw_2 from w_main_root`dw_2 within w_spi_time_query
integer y = 340
integer width = 4242
integer height = 1040
integer taborder = 0
...
type dw_1 from w_main_root`dw_1 within w_spi_time_query
integer y = 340
integer width = 4242
integer height = 1040
integer taborder = 0
boolean titlebar = true
string title = "SIP Result"
string dataobject = "d_qc_machine_inspect_data_lst_spi"
end type
...
type uo_tabpages from w_main_root`uo_tabpages within w_spi_time_query
integer taborder = 0
end type
