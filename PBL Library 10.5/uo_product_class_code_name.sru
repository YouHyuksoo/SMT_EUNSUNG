HA$PBExportHeader$uo_product_class_code_name.sru
forward
global type uo_product_class_code_name from dropdownlistbox
end type
type st_vendor from structure within uo_product_class_code_name
end type
end forward
...
global uo_product_class_code_name uo_product_class_code_name
...
SELECT DISTINCT PRODUCT_CLASS_CODE||':'||DECODE(:GVS_LANGUAGE, 'K', PRODUCT_CLASS_NAME, 'E', PRODUCT_CLASS_NAME, PRODUCT_CLASS_NAME)
FROM ID_PRODUCT_CLASS
...
on uo_product_class_code_name.create
end on

on uo_product_class_code_name.destroy
end on
