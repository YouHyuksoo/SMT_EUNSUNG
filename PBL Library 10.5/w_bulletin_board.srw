HA$PBExportHeader$w_bulletin_board.srw
$PBExportComments$Notice Board Window
forward
global type w_bulletin_board from window
end type
type uo_dateend from uo_ymd_calendar within w_bulletin_board
end type
type uo_dateset from uo_ymd_calendar within w_bulletin_board
end type
type ddlb_dept_code from uo_department_code_all within w_bulletin_board
end type
type sle_2 from so_singlelineedit within w_bulletin_board
end type
type st_4 from so_statictext within w_bulletin_board
end type
type cbx_1 from so_checkbox within w_bulletin_board
end type
type pb_7 from so_picturebutton within w_bulletin_board
end type
type st_3 from so_statictext within w_bulletin_board
end type
type sle_1 from so_singlelineedit within w_bulletin_board
end type
type st_1 from so_statictext within w_bulletin_board
end type
type st_2 from so_statictext within w_bulletin_board
end type
type pb_show from so_picturebutton within w_bulletin_board
end type
type pb_refresh from so_picturebutton within w_bulletin_board
end type
type pb_save from so_picturebutton within w_bulletin_board
end type
type pb_delete from so_picturebutton within w_bulletin_board
end type
type pb_modify from so_picturebutton within w_bulletin_board
end type
type pb_new from so_picturebutton within w_bulletin_board
end type
type pb_replay from so_picturebutton within w_bulletin_board
end type
type pb_view from so_picturebutton within w_bulletin_board
end type
type dw_favorites from so_datawindow within w_bulletin_board
end type
type dw_monitor from so_datawindow within w_bulletin_board
end type
type dw_board from so_datawindow within w_bulletin_board
end type
type dw_work_board_content from so_datawindow within w_bulletin_board
end type
type dw_report from so_datawindow within w_bulletin_board
end type
end forward
...
global w_bulletin_board w_bulletin_board
