HA$PBExportHeader$w_qc_machine_inspect_data_reflow_query.srw
$PBExportComments$$$HEX3$$30bcb8d2a8b0$$ENDHEX$$
forward
global type w_qc_machine_inspect_data_reflow_query from w_main_root
end type
type st_label from so_statictext within w_qc_machine_inspect_data_reflow_query
end type
type st_4 from so_statictext within w_qc_machine_inspect_data_reflow_query
end type
type uo_dateset from uo_ymd_calendar within w_qc_machine_inspect_data_reflow_query
end type
type uo_dateend from uo_ymd_calendar within w_qc_machine_inspect_data_reflow_query
end type
type st_2 from so_statictext within w_qc_machine_inspect_data_reflow_query
end type
type ddlb_line_code from uo_line_code within w_qc_machine_inspect_data_reflow_query
end type
type st_3 from so_statictext within w_qc_machine_inspect_data_reflow_query
end type
type sle_job_file from singlelineedit within w_qc_machine_inspect_data_reflow_query
end type
type gb_3 from so_groupbox within w_qc_machine_inspect_data_reflow_query
end type
end forward
...
integer width = 5737
integer height = 2840
string title = "Reflow Result Query"
...
st_3 st_3
sle_job_file sle_job_file
gb_3 gb_3
end type
global w_qc_machine_inspect_data_reflow_query w_qc_machine_inspect_data_reflow_query
...
on w_qc_machine_inspect_data_reflow_query.create
int iCurrent
call super::create
...
this.sle_job_file=create sle_job_file
...
this.Control[iCurrent+8]=this.sle_job_file
this.Control[iCurrent+9]=this.gb_3
end on

on w_qc_machine_inspect_data_reflow_query.destroy
call super::destroy
...
choose case gvs_ue_data_control
	...
	case 'RETRIEVE'
			...
			dw_1.retrieve(   uo_dateset.text( ) , uo_dateend.text( ) , ddlb_line_code.getcode()+'%' , sle_job_file.text+'%')
...
type dw_5 from w_main_root`dw_5 within w_qc_machine_inspect_data_reflow_query
integer y = 340
integer width = 4242
integer height = 1040
integer taborder = 0
...
type dw_4 from w_main_root`dw_4 within w_qc_machine_inspect_data_reflow_query
integer y = 340
integer width = 4242
integer height = 1040
integer taborder = 0
...
type dw_3 from w_main_root`dw_3 within w_qc_machine_inspect_data_reflow_query
integer y = 340
integer width = 4238
integer height = 1040
integer taborder = 0
...
type dw_2 from w_main_root`dw_2 within w_qc_machine_inspect_data_reflow_query
integer y = 340
integer width = 4242
integer height = 1040
integer taborder = 0
...
type dw_1 from w_main_root`dw_1 within w_qc_machine_inspect_data_reflow_query
integer y = 340
integer width = 4969
integer height = 2224
integer taborder = 0
boolean titlebar = true
string title = "Reflow Result"
string dataobject = "d_qc_machine_inspect_data_lst_reflow"
end type
...
type uo_tabpages from w_main_root`uo_tabpages within w_qc_machine_inspect_data_reflow_query
integer taborder = 0
end type
