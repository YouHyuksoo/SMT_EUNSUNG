HA$PBExportHeader$w_mcn_jig_input_history_master.srw
$PBExportComments$JIG input history
forward
global type w_mcn_jig_input_history_master from w_main_root
end type
type sle_jig_lot_no from so_singlelineedit within w_mcn_jig_input_history_master
end type
type st_1 from so_statictext within w_mcn_jig_input_history_master
end type
type sle_model_item from so_singlelineedit within w_mcn_jig_input_history_master
end type
type st_3 from so_statictext within w_mcn_jig_input_history_master
end type
type ddlb_jig_type from uo_basecode within w_mcn_jig_input_history_master
end type
type st_6 from so_statictext within w_mcn_jig_input_history_master
end type
type ddlb_line_code from uo_line_code within w_mcn_jig_input_history_master
end type
type st_line_code from statictext within w_mcn_jig_input_history_master
end type
type st_4 from so_statictext within w_mcn_jig_input_history_master
end type
type uo_dateset from uo_ymd_calendar within w_mcn_jig_input_history_master
end type
type uo_dateend from uo_ymd_calendar within w_mcn_jig_input_history_master
end type
type gb_1 from groupbox within w_mcn_jig_input_history_master
end type
end forward
...
integer width = 5367
integer height = 3104
string title = "JIG Input History Master"
sle_jig_lot_no sle_jig_lot_no
st_1 st_1
sle_model_item sle_model_item
st_3 st_3
...
global w_mcn_jig_input_history_master w_mcn_jig_input_history_master

on w_mcn_jig_input_history_master.create
int iCurrent
call super::create
this.sle_jig_lot_no=create sle_jig_lot_no
this.st_1=create st_1
this.sle_model_item=create sle_model_item
...
this.Control[iCurrent+3]=this.sle_model_item
...
on w_mcn_jig_input_history_master.destroy
call super::destroy
destroy(this.sle_jig_lot_no)
destroy(this.st_1)
destroy(this.sle_model_item)
destroy(this.st_3)
...
CHOOSE CASE Gvs_Ue_DATA_control
	CASE 'RETRIEVE'
				...
				DW_1.RESET( )
				DW_1.RETRIEVE(  uo_dateset.text(), uo_dateend.text(), ddlb_line_code.getcode( )+'%' ,  ddlb_jig_type.getcode( )+'%' , sle_jig_lot_no.text+'%' ,  sle_model_item.text+'%' ,  Gvi_organization_id)
...
type dw_5 from w_main_root`dw_5 within w_mcn_jig_input_history_master
integer y = 288
end type

type dw_4 from w_main_root`dw_4 within w_mcn_jig_input_history_master
integer y = 288
integer taborder = 80
end type

type dw_3 from w_main_root`dw_3 within w_mcn_jig_input_history_master
integer x = 2126
integer y = 1676
integer width = 2478
integer height = 992
...
type dw_2 from w_main_root`dw_2 within w_mcn_jig_input_history_master
integer x = 5
integer y = 1676
integer width = 2112
integer height = 992
...
type dw_1 from w_main_root`dw_1 within w_mcn_jig_input_history_master
integer y = 292
integer width = 4626
integer height = 2384
boolean titlebar = true
string title = "JIG Input History"
string dataobject = "d_mcn_jig_input_history_query"
end type
...
type uo_tabpages from w_main_root`uo_tabpages within w_mcn_jig_input_history_master
end type
