HA$PBExportHeader$w_aoi_time_query.srw
$PBExportComments$aoi_time_query
forward
global type w_aoi_time_query from w_main_root
end type
type st_label from so_statictext within w_aoi_time_query
end type
type st_6 from so_statictext within w_aoi_time_query
end type
type st_1 from so_statictext within w_aoi_time_query
end type
type uo_dateset from uo_ymdh_calendar within w_aoi_time_query
end type
type uo_datesete from uo_ymdh_calendar within w_aoi_time_query
end type
type sle_model from singlelineedit within w_aoi_time_query
end type
type gb_3 from so_groupbox within w_aoi_time_query
end type
end forward
...
integer width = 5737
integer height = 2840
string title = "AOI TIME QUERY"
string ivs_dw_4_use_focusindicator = "Y"
st_label st_label
st_6 st_6
st_1 st_1
uo_dateset uo_dateset
uo_datesete uo_datesete
sle_model sle_model
gb_3 gb_3
end type
global w_aoi_time_query w_aoi_time_query
...
this.uo_datesete=create uo_datesete
...
this.Control[iCurrent+5]=this.uo_datesete
this.Control[iCurrent+6]=this.sle_model
this.Control[iCurrent+7]=this.gb_3
end on

on w_aoi_time_query.destroy
call super::destroy
destroy(this.st_label)
destroy(this.st_6)
destroy(this.st_1)
destroy(this.uo_dateset)
destroy(this.uo_datesete)
...
select to_char(sysdate + 1 , 'yyyy/mm/dd') 
 ...
 uo_datesete.settext(lvs_date) 
 
 uo_dateset.settime('06')
 uo_datesete.settime('06')
...
STRING Model, lvs_numb
INT i

STRING lvs_start, lvs_end

lvs_start = string(uo_dateset.text(),'YYYYMMDDHH') 
lvs_end = string(uo_datesete.text(),'YYYYMMDDHH')
...
choose case gvs_ue_data_control
	...
	case 'RETRIEVE'
			...
			dw_1.retrieve(lvs_start, lvs_end, Model)
...
type dw_5 from w_main_root`dw_5 within w_aoi_time_query
integer y = 328
integer width = 4242
integer height = 1040
integer taborder = 0
...
type dw_4 from w_main_root`dw_4 within w_aoi_time_query
integer y = 328
integer width = 4242
integer height = 1040
integer taborder = 0
...
type dw_3 from w_main_root`dw_3 within w_aoi_time_query
integer y = 328
integer width = 4238
integer height = 1040
integer taborder = 0
...
type dw_2 from w_main_root`dw_2 within w_aoi_time_query
integer y = 328
integer width = 4242
integer height = 1040
integer taborder = 0
...
type dw_1 from w_main_root`dw_1 within w_aoi_time_query
integer y = 328
integer width = 4969
integer height = 2224
integer taborder = 0
...
string dataobject = "d_aoi_time_query"
end type
...
type uo_tabpages from w_main_root`uo_tabpages within w_aoi_time_query
integer taborder = 0
end type
