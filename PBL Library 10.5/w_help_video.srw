HA$PBExportHeader$w_help_video.srw
$PBExportComments$Help Video Master
forward
global type w_help_video from w_main_root
end type
type sle_help_keyword from so_singlelineedit within w_help_video
end type
type st_2 from so_statictext within w_help_video
end type
type cb_1 from so_commandbutton within w_help_video
end type
type cb_2 from so_commandbutton within w_help_video
end type
type cb_view_help from so_commandbutton within w_help_video
end type
type st_1 from so_statictext within w_help_video
end type
type sle_help_group from so_singlelineedit within w_help_video
end type
type gb_1 from so_groupbox within w_help_video
end type
type gb_2 from so_groupbox within w_help_video
end type
end forward
...
integer width = 5367
integer height = 3144
string title = "Help Video"
sle_help_keyword sle_help_keyword
st_2 st_2
cb_1 cb_1
cb_2 cb_2
cb_view_help cb_view_help
st_1 st_1
sle_help_group sle_help_group
gb_1 gb_1
gb_2 gb_2
end type
global w_help_video w_help_video

type variables
datawindow ivd_data_window
end variables

on w_help_video.create
int iCurrent
call super::create
this.sle_help_keyword=create sle_help_keyword
this.st_2=create st_2
this.cb_1=create cb_1
this.cb_2=create cb_2
this.cb_view_help=create cb_view_help
this.st_1=create st_1
this.sle_help_group=create sle_help_group
this.gb_1=create gb_1
this.gb_2=create gb_2
iCurrent=UpperBound(this.Control)
this.Control[iCurrent+1]=this.sle_help_keyword
this.Control[iCurrent+2]=this.st_2
this.Control[iCurrent+3]=this.cb_1
this.Control[iCurrent+4]=this.cb_2
this.Control[iCurrent+5]=this.cb_view_help
this.Control[iCurrent+6]=this.st_1
this.Control[iCurrent+7]=this.sle_help_group
this.Control[iCurrent+8]=this.gb_1
this.Control[iCurrent+9]=this.gb_2
end on

on w_help_video.destroy
call super::destroy
destroy(this.sle_help_keyword)
destroy(this.st_2)
destroy(this.cb_1)
destroy(this.cb_2)
destroy(this.cb_view_help)
destroy(this.st_1)
destroy(this.sle_help_group)
destroy(this.gb_1)
destroy(this.gb_2)
end on
...
CHOOSE CASE Gvs_Ue_data_control
	CASE 'RETRIEVE'
			...
			dw_1.RETRIEVE(SLE_HELP_GROUP.TEXT+'%' , SLE_HELP_KEYWORD.TEXT+'%' , GVI_ORGANIZATION_ID)
               dw_1.SETFOCUS()
	...
	CASE 'INSERT'
			...
			SELECT MAX(HELP_ID)+1 INTO :LVL_HELP_ID
			...
			DW_1.OBJECT.HELP_ID[ROW] = LVL_HELP_ID
...
type dw_5 from w_main_root`dw_5 within w_help_video
boolean visible = false
integer y = 352
integer taborder = 0
end type

type dw_4 from w_main_root`dw_4 within w_help_video
boolean visible = false
integer y = 352
integer taborder = 50
end type

type dw_3 from w_main_root`dw_3 within w_help_video
boolean visible = false
integer y = 352
integer taborder = 60
end type

type dw_2 from w_main_root`dw_2 within w_help_video
integer x = 5
integer y = 2000
integer width = 4498
integer height = 964
...
string title = "Help Detail"
string dataobject = "d_help_video_mst"
...
event dw_2::resize;call super::resize;this.object.help_keyword.width = this.width
this.object.help_comment.width = this.width
this.object.help_comment.height = this.height
end event

type dw_1 from w_main_root`dw_1 within w_help_video
integer y = 308
integer width = 4507
integer height = 1684
integer taborder = 0
...
string dataobject = "d_help_video_lst"
end type
...
type uo_tabpages from w_main_root`uo_tabpages within w_help_video
end type
