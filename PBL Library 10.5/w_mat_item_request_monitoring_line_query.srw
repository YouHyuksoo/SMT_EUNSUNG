HA$PBExportHeader$w_mat_item_request_monitoring_line_query.srw
$PBExportComments$$$HEX4$$ddc0b0c0c4ac8dd6$$ENDHEX$$
forward
global type w_mat_item_request_monitoring_line_query from w_main_root
end type
type st_item_code from so_statictext within w_mat_item_request_monitoring_line_query
end type
type ddlb_model_name from uo_model_name_ddlb within w_mat_item_request_monitoring_line_query
end type
type em_limit_time from so_editmask within w_mat_item_request_monitoring_line_query
end type
type st_1 from so_statictext within w_mat_item_request_monitoring_line_query
end type
type rb_all from so_radiobutton within w_mat_item_request_monitoring_line_query
end type
type rb_active from so_radiobutton within w_mat_item_request_monitoring_line_query
end type
type cb_1 from so_commandbutton within w_mat_item_request_monitoring_line_query
end type
type em_interval from so_editmask within w_mat_item_request_monitoring_line_query
end type
type st_2 from so_statictext within w_mat_item_request_monitoring_line_query
end type
type cb_2 from so_commandbutton within w_mat_item_request_monitoring_line_query
end type
type em_item_unit_qty from so_editmask within w_mat_item_request_monitoring_line_query
end type
type st_3 from so_statictext within w_mat_item_request_monitoring_line_query
end type
type em_limit_qty from so_editmask within w_mat_item_request_monitoring_line_query
end type
type st_4 from so_statictext within w_mat_item_request_monitoring_line_query
end type
type dw_6 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_7 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_8 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_9 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_10 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_11 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_12 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_13 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_14 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_15 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_16 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_17 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_18 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_19 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type dw_20 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
type cb_3 from so_commandbutton within w_mat_item_request_monitoring_line_query
end type
type ddlb_line_code from uo_line_code_smt within w_mat_item_request_monitoring_line_query
end type
type gb_1 from so_groupbox within w_mat_item_request_monitoring_line_query
end type
type gb_3 from so_groupbox within w_mat_item_request_monitoring_line_query
end type
type gb_4 from so_groupbox within w_mat_item_request_monitoring_line_query
end type
type gb_6 from so_groupbox within w_mat_item_request_monitoring_line_query
end type
type dw_21 from so_datawindow within w_mat_item_request_monitoring_line_query
end type
end forward
...
integer width = 7045
integer height = 2804
string title = "Materials Status Monitoring"
...
st_2 st_2
cb_2 cb_2
em_item_unit_qty em_item_unit_qty
st_3 st_3
...
global w_mat_item_request_monitoring_line_query w_mat_item_request_monitoring_line_query
...
on w_mat_item_request_monitoring_line_query.create
int iCurrent
call super::create
...
this.em_item_unit_qty=create em_item_unit_qty
...
this.Control[iCurrent+2]=this.ddlb_model_name
this.Control[iCurrent+3]=this.em_limit_time
this.Control[iCurrent+4]=this.st_1
this.Control[iCurrent+5]=this.rb_all
this.Control[iCurrent+6]=this.rb_active
this.Control[iCurrent+7]=this.cb_1
this.Control[iCurrent+8]=this.em_interval
this.Control[iCurrent+9]=this.st_2
this.Control[iCurrent+10]=this.cb_2
this.Control[iCurrent+11]=this.em_item_unit_qty
this.Control[iCurrent+12]=this.st_3
this.Control[iCurrent+13]=this.em_limit_qty
...
this.Control[iCurrent+21]=this.dw_12
this.Control[iCurrent+22]=this.dw_13
this.Control[iCurrent+23]=this.dw_14
this.Control[iCurrent+24]=this.dw_15
this.Control[iCurrent+25]=this.dw_16
this.Control[iCurrent+26]=this.dw_17
this.Control[iCurrent+27]=this.dw_18
this.Control[iCurrent+28]=this.dw_19
this.Control[iCurrent+29]=this.dw_20
this.Control[iCurrent+30]=this.cb_3
this.Control[iCurrent+31]=this.ddlb_line_code
...
this.Control[iCurrent+36]=this.dw_21
end on

on w_mat_item_request_monitoring_line_query.destroy
call super::destroy
...
CHOOSE CASE Gvs_Ue_data_control
	CASE 'RETRIEVE'
				...
				dw_13.SetRedraw(FALSE)
				dw_14.SetRedraw(FALSE)
				dw_15.SetRedraw(FALSE)
				dw_16.SetRedraw(FALSE)
				dw_17.SetRedraw(FALSE)
				dw_18.SetRedraw(FALSE)
				dw_19.SetRedraw(FALSE)
				dw_20.SetRedraw(FALSE)
				...
				dw_1.retrieve( '01' , ddlb_model_name.getcode( ) ,  long(em_limit_time.text),  lvs_active ,  long(em_item_unit_qty.text ) , long(em_limit_qty.text) ,   gvi_organization_id )
				dw_2.retrieve( '02' , ddlb_model_name.getcode( ) ,  long(em_limit_time.text),  lvs_active ,  long(em_item_unit_qty.text ) , long(em_limit_qty.text) ,   gvi_organization_id )
				dw_3.retrieve( '03' , ddlb_model_name.getcode( ) ,  long(em_limit_time.text),  lvs_active ,  long(em_item_unit_qty.text ) , long(em_limit_qty.text) ,   gvi_organization_id )
				dw_4.retrieve( '04' , ddlb_model_name.getcode( ) ,  long(em_limit_time.text),  lvs_active ,  long(em_item_unit_qty.text ) , long(em_limit_qty.text) ,   gvi_organization_id )
				dw_5.retrieve( '05' , ddlb_model_name.getcode( ) ,  long(em_limit_time.text),  lvs_active ,  long(em_item_unit_qty.text ) , long(em_limit_qty.text) ,   gvi_organization_id )
				dw_6.retrieve( '06' , ddlb_model_name.getcode( ) ,  long(em_limit_time.text),  lvs_active ,  long(em_item_unit_qty.text ) , long(em_limit_qty.text) ,   gvi_organization_id )
				dw_7.retrieve( '07' , ddlb_model_name.getcode( ) ,  long(em_limit_time.text),  lvs_active ,  long(em_item_unit_qty.text ) , long(em_limit_qty.text) ,   gvi_organization_id )
				dw_8.retrieve( '08' , ddlb_model_name.getcode( ) ,  long(em_limit_time.text),  lvs_active ,  long(em_item_unit_qty.text ) , long(em_limit_qty.text) ,   gvi_organization_id )
				dw_9.retrieve( '09' , ddlb_model_name.getcode( ) ,  long(em_limit_time.text),  lvs_active ,  long(em_item_unit_qty.text ) , long(em_limit_qty.text) ,   gvi_organization_id )
				dw_10.retrieve( '10' , ddlb_model_name.getcode( ) ,  long(em_limit_time.text),  lvs_active ,  long(em_item_unit_qty.text ) , long(em_limit_qty.text) ,   gvi_organization_id )
				...
				dw_13.SetRedraw(True)
				dw_14.SetRedraw(True)
				dw_15.SetRedraw(True)
				dw_16.SetRedraw(True)
				dw_17.SetRedraw(True)
				dw_18.SetRedraw(True)
				dw_19.SetRedraw(True)
				dw_20.SetRedraw(True)
	CASE ELSE
END CHOOSE
end event
...
type dw_5 from w_main_root`dw_5 within w_mat_item_request_monitoring_line_query
integer x = 2651
integer y = 332
integer width = 663
integer height = 932
...
Gst_return.gvl_return[3]  = long(em_limit_time.text)
Gst_return.gvs_return[4] = lvs_active
Gst_return.gvl_return[5]  = long(em_item_unit_qty.text )
Gst_return.gvl_return[6]  =long(em_limit_qty.text)

openwithparm(w_smt_plan_feeder_monitoring_popup , This ) 
end event

type dw_4 from w_main_root`dw_4 within w_mat_item_request_monitoring_line_query
integer x = 1989
integer y = 332
integer width = 663
integer height = 932
...
type dw_3 from w_main_root`dw_3 within w_mat_item_request_monitoring_line_query
integer x = 1326
integer y = 332
integer width = 663
integer height = 932
...
type dw_2 from w_main_root`dw_2 within w_mat_item_request_monitoring_line_query
integer x = 663
integer y = 332
integer width = 663
integer height = 932
...
type dw_1 from w_main_root`dw_1 within w_mat_item_request_monitoring_line_query
...
type uo_tabpages from w_main_root`uo_tabpages within w_mat_item_request_monitoring_line_query
end type
...
event clicked;call super::clicked;String lvs_active
...
dw_21.Reset()
dw_21.Retrieve(ddlb_line_code.getcode(), ddlb_model_name.getcode( ) ,  long(em_limit_time.text),  lvs_active ,  long(em_item_unit_qty.text ) , long(em_limit_qty.text) ,   gvi_organization_id )

//dw_21.bringtotop = true
If dw_21.RowCount() < 1 Then Return 
dw_21.print()
