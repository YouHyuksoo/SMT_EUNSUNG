HA$PBExportHeader$uo_jig_squeeze_code.sru
$PBExportComments$Line ddlb Object
forward
global type uo_jig_squeeze_code from dropdownlistbox
end type
end forward
...
global uo_jig_squeeze_code uo_jig_squeeze_code
...
on uo_jig_squeeze_code.create
end on

on uo_jig_squeeze_code.destroy
end on
