HA$PBExportHeader$w_mat_ws_inventory_close_excel_import_popup.srw
$PBExportComments$Popup Templet Window
forward
global type w_mat_ws_inventory_close_excel_import_popup from w_popup_root
end type
type cb_update from so_commandbutton within w_mat_ws_inventory_close_excel_import_popup
end type
type cb_2 from so_commandbutton within w_mat_ws_inventory_close_excel_import_popup
end type
type em_close_yyymm from uo_ym within w_mat_ws_inventory_close_excel_import_popup
end type
type st_1 from statictext within w_mat_ws_inventory_close_excel_import_popup
end type
type pb_1 from so_commandbutton within w_mat_ws_inventory_close_excel_import_popup
end type
type gb_3 from so_groupbox within w_mat_ws_inventory_close_excel_import_popup
end type
end forward
...
global w_mat_ws_inventory_close_excel_import_popup w_mat_ws_inventory_close_excel_import_popup

type variables
datawindow idw_datawindow
end variables

on w_mat_ws_inventory_close_excel_import_popup.create
int iCurrent
call super::create
...
on w_mat_ws_inventory_close_excel_import_popup.destroy
call super::destroy
...
type p_title from w_popup_root`p_title within w_mat_ws_inventory_close_excel_import_popup
integer width = 3118
integer weight = 400
...
type cb_sort from w_popup_root`cb_sort within w_mat_ws_inventory_close_excel_import_popup
integer x = 1024
integer y = 0
integer taborder = 40
end type

type cb_close from w_popup_root`cb_close within w_mat_ws_inventory_close_excel_import_popup
...
type st_msg from w_popup_root`st_msg within w_mat_ws_inventory_close_excel_import_popup
boolean visible = true
integer y = 424
integer width = 3118
integer weight = 400
...
type dw_1 from w_popup_root`dw_1 within w_mat_ws_inventory_close_excel_import_popup
boolean visible = true
integer y = 512
integer width = 3118
integer height = 1352
...
string dataobject = "d_mat_item_ws_inventory_close_excel_import_popup"
...
type dw_2 from w_popup_root`dw_2 within w_mat_ws_inventory_close_excel_import_popup
boolean visible = true
integer y = 512
integer width = 1874
integer height = 1324
...
type dw_3 from w_popup_root`dw_3 within w_mat_ws_inventory_close_excel_import_popup
integer y = 856
integer taborder = 50
end type
...
event clicked;delete from IM_ITEM_WS_INVE_CHECK_EXCEL 
