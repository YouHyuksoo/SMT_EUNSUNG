HA$PBExportHeader$uo_machine_code_by_line.sru
$PBExportComments$Line ddlb Object
forward
global type uo_machine_code_by_line from dropdownlistbox
end type
end forward
...
global uo_machine_code_by_line uo_machine_code_by_line
...
DECLARE CUR_01 CURSOR FOR 
  SELECT IMCN_MACHINE.MACHINE_CODE,   
    ...
    FROM IMCN_MACHINE  
  WHERE IMCN_MACHINE.LINE_CODE = :ARG_LINE_CODE
...
on uo_machine_code_by_line.create
end on

on uo_machine_code_by_line.destroy
end on
