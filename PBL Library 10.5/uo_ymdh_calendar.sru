HA$PBExportHeader$uo_ymdh_calendar.sru
$PBExportComments$yyyy mm dd Calendar Today
forward
global type uo_ymdh_calendar from userobject
end type
type em_2 from editmask within uo_ymdh_calendar
end type
type cb_first from commandbutton within uo_ymdh_calendar
end type
type cb_1 from commandbutton within uo_ymdh_calendar
end type
type em_yyyymm from editmask within uo_ymdh_calendar
end type
type hsb_1 from hscrollbar within uo_ymdh_calendar
end type
type em_1 from editmask within uo_ymdh_calendar
end type
type dw_1 from datawindow within uo_ymdh_calendar
end type
end forward
...
global uo_ymdh_calendar uo_ymdh_calendar
