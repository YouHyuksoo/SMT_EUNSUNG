HA$PBExportHeader$uo_line_code.sru
$PBExportComments$Line ddlb Object
forward
global type uo_line_code from dropdownlistbox
end type
end forward
...
global uo_line_code uo_line_code
...
DO 
	FETCH CUR_01 INTO :LVS_LINE_CODE , :LVS_LINE_NAME, :LVS_LINE_CODE_CONDITION ;
...
on uo_line_code.create
end on

on uo_line_code.destroy
end on
