HA$PBExportHeader$uo_item_code.sru
$PBExportComments$Item Code
forward
global type uo_item_code from dropdownlistbox
end type
type st_vendor from structure within uo_item_code
end type
end forward
...
global uo_item_code uo_item_code
...
on uo_item_code.create
end on

on uo_item_code.destroy
end on

event rbuttondown;openwithparm(w_des_item_popup , UPPER(this.text))
