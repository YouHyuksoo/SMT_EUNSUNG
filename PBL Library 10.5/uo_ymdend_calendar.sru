HA$PBExportHeader$uo_ymdend_calendar.sru
$PBExportComments$yyyy mm dd Calendar Today + 15
forward
global type uo_ymdend_calendar from userobject
end type
type cb_1 from commandbutton within uo_ymdend_calendar
end type
type st_1 from statictext within uo_ymdend_calendar
end type
type em_yyyymm from editmask within uo_ymdend_calendar
end type
type hsb_1 from hscrollbar within uo_ymdend_calendar
end type
type dw_1 from datawindow within uo_ymdend_calendar
end type
type em_1 from editmask within uo_ymdend_calendar
end type
end forward
...
event ue_activate pbm_mouseactivate
...
global uo_ymdend_calendar uo_ymdend_calendar
...
event ue_activate;THIS.BRINGTOTOP = TRUE
end event
...
public subroutine uf_small ();WIDTH  = EM_1.WIDTH
HEIGHT = EM_1.HEIGHT
end subroutine
...
event constructor;SELECT TO_CHAR(SYSDATE + :GVI_DATEEND_RANGE ,'YYYY/MM/DD') INTO :TEXT FROM DUAL ;
end event
