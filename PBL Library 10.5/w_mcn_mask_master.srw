HA$PBExportHeader$w_mcn_mask_master.srw
$PBExportComments$Customer Infromation Manage
forward
global type w_mcn_mask_master from w_main_root
end type
type sle_feeder_lot_no from so_singlelineedit within w_mcn_mask_master
end type
type st_1 from so_statictext within w_mcn_mask_master
end type
type st_2 from so_statictext within w_mcn_mask_master
end type
type sle_jig_name from so_singlelineedit within w_mcn_mask_master
end type
type sle_model_name from so_singlelineedit within w_mcn_mask_master
end type
type st_3 from so_statictext within w_mcn_mask_master
end type
type cb_7 from so_commandbutton within w_mcn_mask_master
end type
type cb_9 from so_commandbutton within w_mcn_mask_master
end type
type ddlb_line_code from uo_line_code within w_mcn_mask_master
end type
type st_line_code from statictext within w_mcn_mask_master
end type
type ddlb_jig_status from uo_basecode within w_mcn_mask_master
end type
type st_4 from statictext within w_mcn_mask_master
end type
type cb_1 from so_commandbutton within w_mcn_mask_master
end type
type gb_1 from groupbox within w_mcn_mask_master
end type
type gb_3 from groupbox within w_mcn_mask_master
end type
type gb_2 from groupbox within w_mcn_mask_master
end type
end forward
...
global w_mcn_mask_master w_mcn_mask_master

on w_mcn_mask_master.create
int iCurrent
call super::create
...
CHOOSE CASE Gvs_Ue_DATA_control
	CASE 'RETRIEVE'
				...
				DW_1.RESET( )
				DW_1.RETRIEVE(  '%' ,  sle_feeder_lot_no.text+'%' , sle_model_name.text+'%' ,  'M' ,   ddlb_line_code.text+'%' , ddlb_jig_status.getcode( )+'%' ,   Gvi_organization_id )
...
type dw_5 from w_main_root`dw_5 within w_mcn_mask_master
integer y = 288
end type

type dw_4 from w_main_root`dw_4 within w_mcn_mask_master
integer y = 288
integer taborder = 80
end type

type dw_3 from w_main_root`dw_3 within w_mcn_mask_master
integer x = 2126
integer y = 1676
integer width = 2478
integer height = 992
...
event dw_3::rbuttondown;call super::rbuttondown;if dwo.name = 'item_code' then 
	...
	if Gst_return.gvb_return = true then 
		...
		this.object.item_code[row] = Gst_return.gvs_return[2]  //$$HEX17$$00b35cd42000a8ba78b320000d000a00090009000d000a00090009000d000a000900$$ENDHEX$$end if 
...
elseif dwo.name = 'smt_model_name' then 
	...
	if Gst_return.gvb_return = true then 
		...
		this.object.item_code[row] = Gst_return.gvs_return[1]  //smt $$HEX6$$a8ba78b320000d000a000900$$ENDHEX$$end if 
end if 
end event

type dw_2 from w_main_root`dw_2 within w_mcn_mask_master
integer x = 5
integer y = 1676
integer width = 2112
integer height = 992
...
boolean titlebar = true
string title = "Mask Detail List"
string dataobject = "d_mcn_mask_mst"
...
type dw_1 from w_main_root`dw_1 within w_mcn_mask_master
integer y = 292
integer width = 4599
integer height = 1372
boolean titlebar = true
string title = "Mask List"
string dataobject = "d_mcn_mask_lst"
end type
...
type uo_tabpages from w_main_root`uo_tabpages within w_mcn_mask_master
end type
...
dw_2.object.jig_status[dw_2.getrow()] = 'B' //$$HEX5$$d0d330ae20000d000a00$$ENDHEX$$dw_2.object.use_status[dw_2.getrow()] = 'S' //$$HEX9$$acc0a9c611c9c0c920000d000a000d000a00$$ENDHEX$$if dw_2.update( ) < 0 then 
	rollback;
else
	commit ;
end if
