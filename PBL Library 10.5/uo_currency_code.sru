HA$PBExportHeader$uo_currency_code.sru
forward
global type uo_currency_code from dropdownlistbox
end type
type st_vendor from structure within uo_currency_code
end type
end forward
...
global uo_currency_code uo_currency_code
...
on uo_currency_code.create
end on

on uo_currency_code.destroy
end on
