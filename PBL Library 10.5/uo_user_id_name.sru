HA$PBExportHeader$uo_user_id_name.sru
forward
global type uo_user_id_name from dropdownlistbox
end type
end forward
...
global uo_user_id_name uo_user_id_name
...
on uo_user_id_name.create
end on

on uo_user_id_name.destroy
end on
