HA$PBExportHeader$w_mcn_jig_repair_master.srw
$PBExportComments$Material Receipt Master
forward
global type w_mcn_jig_repair_master from w_main_root
end type
type uo_dateset from uo_ymd_calendar within w_mcn_jig_repair_master
end type
type uo_dateend from uo_ymd_calendar within w_mcn_jig_repair_master
end type
type st_3 from so_statictext within w_mcn_jig_repair_master
end type
type st_4 from so_statictext within w_mcn_jig_repair_master
end type
type sle_jig_code from so_singlelineedit within w_mcn_jig_repair_master
end type
type cb_7 from so_commandbutton within w_mcn_jig_repair_master
end type
type cb_9 from so_commandbutton within w_mcn_jig_repair_master
end type
type rb_jig_list from so_radiobutton within w_mcn_jig_repair_master
end type
type rb_jig_request from so_radiobutton within w_mcn_jig_repair_master
end type
type ddlb_jig_repair_status from uo_basecode within w_mcn_jig_repair_master
end type
type st_1 from so_statictext within w_mcn_jig_repair_master
end type
type cb_process from so_commandbutton within w_mcn_jig_repair_master
end type
type cb_complete from so_commandbutton within w_mcn_jig_repair_master
end type
type ddlb_jig_type from uo_basecode within w_mcn_jig_repair_master
end type
type st_6 from so_statictext within w_mcn_jig_repair_master
end type
type sle_jig_lot_no from so_singlelineedit within w_mcn_jig_repair_master
end type
type st_2 from so_statictext within w_mcn_jig_repair_master
end type
type gb_2 from so_groupbox within w_mcn_jig_repair_master
end type
type gb_1 from groupbox within w_mcn_jig_repair_master
end type
type gb_3 from groupbox within w_mcn_jig_repair_master
end type
type gb_4 from groupbox within w_mcn_jig_repair_master
end type
end forward
...
integer width = 4827
integer height = 3028
string title = "Jig Repair Master"
...
global w_mcn_jig_repair_master w_mcn_jig_repair_master

on w_mcn_jig_repair_master.create
int iCurrent
call super::create
...
this.Control[iCurrent+8]=this.rb_jig_list
this.Control[iCurrent+9]=this.rb_jig_request
this.Control[iCurrent+10]=this.ddlb_jig_repair_status
this.Control[iCurrent+11]=this.st_1
this.Control[iCurrent+12]=this.cb_process
this.Control[iCurrent+13]=this.cb_complete
this.Control[iCurrent+14]=this.ddlb_jig_type
this.Control[iCurrent+15]=this.st_6
this.Control[iCurrent+16]=this.sle_jig_lot_no
...
on w_mcn_jig_repair_master.destroy
call super::destroy
...
choose case gvs_ue_data_control
	...
	case 'RETRIEVE'
			...
			if rb_jig_request.checked = true then 
				    dw_1.retrieve(sle_jig_code.text + '%', ddlb_jig_repair_status.getcode( )+'%' , uo_dateset.text() , uo_dateend.text() ,   ddlb_jig_type.getcode( )+'%' ,  sle_jig_lot_no.text+'%' ,  gvi_organization_id)
...
type dw_5 from w_main_root`dw_5 within w_mcn_jig_repair_master
integer y = 520
integer height = 160
end type

type dw_4 from w_main_root`dw_4 within w_mcn_jig_repair_master
integer y = 520
integer height = 160
end type

type dw_3 from w_main_root`dw_3 within w_mcn_jig_repair_master
integer y = 520
integer width = 4544
integer height = 1092
...
type dw_2 from w_main_root`dw_2 within w_mcn_jig_repair_master
integer y = 1620
integer width = 4549
integer height = 824
boolean titlebar = true
string title = "Jig Repair Change Request List"
string dataobject = "d_mcn_jig_repair_lst"
...
type dw_1 from w_main_root`dw_1 within w_mcn_jig_repair_master
integer y = 520
integer width = 4544
integer height = 1092
boolean titlebar = true
string title = "Jig Repair Change Request List"
string dataobject = "d_mcn_jig_repair_change_request_lst"
end type
...
type uo_tabpages from w_main_root`uo_tabpages within w_mcn_jig_repair_master
end type
...
boolean bringtotop = true
integer weight = 700
string text = "Jig Request Wait List"
