HA$PBExportHeader$uo_jig_nozzle_code.sru
$PBExportComments$Line ddlb Object
forward
global type uo_jig_nozzle_code from dropdownlistbox
end type
end forward
...
global uo_jig_nozzle_code uo_jig_nozzle_code
...
on uo_jig_nozzle_code.create
end on

on uo_jig_nozzle_code.destroy
end on
