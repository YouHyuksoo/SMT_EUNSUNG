HA$PBExportHeader$uo_line_code_suply.sru
$PBExportComments$Line ddlb Object
forward
global type uo_line_code_suply from dropdownlistbox
end type
end forward
...
global uo_line_code_suply uo_line_code_suply
...
on uo_line_code_suply.create
end on

on uo_line_code_suply.destroy
end on
