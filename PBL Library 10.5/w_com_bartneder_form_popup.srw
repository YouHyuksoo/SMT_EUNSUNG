HA$PBExportHeader$w_com_bartneder_form_popup.srw
$PBExportComments$(Item Query)-$$HEX4$$80bd88d470c88cd6$$ENDHEX$$
forward
global type w_com_bartneder_form_popup from w_popup_root
end type
type cb_select from commandbutton within w_com_bartneder_form_popup
end type
type cb_retrieve from commandbutton within w_com_bartneder_form_popup
end type
type sle_box_no from so_singlelineedit within w_com_bartneder_form_popup
end type
type st_5 from statictext within w_com_bartneder_form_popup
end type
type em_copy from so_editmask within w_com_bartneder_form_popup
end type
type st_6 from so_statictext within w_com_bartneder_form_popup
end type
type gb_2 from so_groupbox within w_com_bartneder_form_popup
end type
type gb_3 from so_groupbox within w_com_bartneder_form_popup
end type
end forward
...
global w_com_bartneder_form_popup w_com_bartneder_form_popup
...
on w_com_bartneder_form_popup.create
int iCurrent
call super::create
...
on w_com_bartneder_form_popup.destroy
call super::destroy
...
type p_title from w_popup_root`p_title within w_com_bartneder_form_popup
integer width = 2213
integer height = 188
long backcolor = 16777215
end type

type cb_sort from w_popup_root`cb_sort within w_com_bartneder_form_popup
integer x = 3529
integer y = 276
integer width = 329
integer height = 156
...
type cb_close from w_popup_root`cb_close within w_com_bartneder_form_popup
...
type st_msg from w_popup_root`st_msg within w_com_bartneder_form_popup
boolean visible = true
integer y = 544
integer width = 2258
end type

type dw_1 from w_popup_root`dw_1 within w_com_bartneder_form_popup
boolean visible = true
integer y = 644
integer width = 2258
integer height = 748
...
type dw_2 from w_popup_root`dw_2 within w_com_bartneder_form_popup
boolean visible = true
integer y = 644
integer width = 2213
integer height = 392
...
type dw_3 from w_popup_root`dw_3 within w_com_bartneder_form_popup
boolean visible = true
integer y = 644
integer width = 2213
integer height = 392
...
Lvl_return = f_download_label_form_data_by_type ( ivs_model_name  ,'B')
