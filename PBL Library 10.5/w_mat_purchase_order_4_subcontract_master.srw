HA$PBExportHeader$w_mat_purchase_order_4_subcontract_master.srw
$PBExportComments$Material Purchase Order Master
forward
global type w_mat_purchase_order_4_subcontract_master from w_main_root
end type
type st_1 from so_statictext within w_mat_purchase_order_4_subcontract_master
end type
type ddlb_item_code from uo_item_code within w_mat_purchase_order_4_subcontract_master
end type
type st_3 from so_statictext within w_mat_purchase_order_4_subcontract_master
end type
type uo_dateset from uo_ymd_calendar within w_mat_purchase_order_4_subcontract_master
end type
type rb_lst from so_radiobutton within w_mat_purchase_order_4_subcontract_master
end type
type rb_hst from so_radiobutton within w_mat_purchase_order_4_subcontract_master
end type
type st_4 from so_statictext within w_mat_purchase_order_4_subcontract_master
end type
type ddlb_supplier_code from uo_supplier_code within w_mat_purchase_order_4_subcontract_master
end type
type uo_dateend from uo_ymdend_calendar within w_mat_purchase_order_4_subcontract_master
end type
type tab_1 from tab within w_mat_purchase_order_4_subcontract_master
end type
...
type st_7 from so_statictext within w_mat_purchase_order_4_subcontract_master
end type
type sle_order_group_no from so_singlelineedit within w_mat_purchase_order_4_subcontract_master
end type
type sle_item_name from so_singlelineedit within w_mat_purchase_order_4_subcontract_master
end type
type st_14 from so_statictext within w_mat_purchase_order_4_subcontract_master
end type
type sle_1 from so_singlelineedit within w_mat_purchase_order_4_subcontract_master
end type
type st_5 from so_statictext within w_mat_purchase_order_4_subcontract_master
end type
type gb_1 from so_groupbox within w_mat_purchase_order_4_subcontract_master
end type
type gb_5 from so_groupbox within w_mat_purchase_order_4_subcontract_master
end type
end forward
...
integer width = 4754
integer height = 2712
string title = "Purchase Order for Outside Master"
st_1 st_1
...
global w_mat_purchase_order_4_subcontract_master w_mat_purchase_order_4_subcontract_master

type variables
string ivs_preview_yn = 'N'
end variables

on w_mat_purchase_order_4_subcontract_master.create
int iCurrent
call super::create
...
this.Control[iCurrent+12]=this.sle_order_group_no
...
on w_mat_purchase_order_4_subcontract_master.destroy
call super::destroy
destroy(this.st_1)
...
//========================================================
// $$HEX6$$08c7c4b3b0c6200024c185ba$$ENDHEX$$
//========================================================

//=============================================================
// $$HEX23$$34bbc1c03cc75cb82000c5c5b4ccd0c52000f5ac09ae5cd5c4d62000e4b2dcc2200085c7e0ac20b484b594b22000$$ENDHEX$$origin_mfs $$HEX16$$d0c5200085c725b81cb4200012ac3cc75cb8200074d5f9b22000c5c5b4cc58c7$$ENDHEX$$
// $$HEX10$$acc7e0ac7cb9200010ac8cc1dcc2a8d0e4b22000$$ENDHEX$$material_mfs  $$HEX30$$94b22000e0c2dcad5cb8200085c7e0ac18b494b220006fb8b8d2200088bc38d630ae20004cb538bbd0c52000acc0a9c658d574ba200048c51cb4e4b2$$ENDHEX$$.
// $$HEX4$$d0c6acc7ccb82000$$ENDHEX$$lot $$HEX20$$88bc38d6d0c5200058c75cd52000200034bbc1c02000acc009ae20009ccde0ac200098ccacb92000$$ENDHEX$$, bom $$HEX15$$44c7200004c81cac200058d5c0c920004ac5e0ac2000d0c6acc7ccb82000$$ENDHEX$$orign mfs  $$HEX8$$88bc38d620007cb92000a4d05cb82000$$ENDHEX$$
// $$HEX12$$acc009ae98cc2000d0c51cc120009ccde0ac200098ccacb9$$ENDHEX$$
//=============================================================		
end event
...
type dw_5 from w_main_root`dw_5 within w_mat_purchase_order_4_subcontract_master
integer y = 548
integer height = 424
end type

type dw_4 from w_main_root`dw_4 within w_mat_purchase_order_4_subcontract_master
integer y = 548
integer width = 4544
integer height = 1012
boolean titlebar = true
string title = "Purchase Order Sheet"
string dataobject = "d_mat_purchase_order_rpt"
end type

type dw_3 from w_main_root`dw_3 within w_mat_purchase_order_4_subcontract_master
integer y = 548
integer width = 4544
integer height = 1012
boolean titlebar = true
string title = "Material Purchase Order for Outside History"
string dataobject = "d_mat_purchase_4_free_order_group_lst"
end type
...
type dw_2 from w_main_root`dw_2 within w_mat_purchase_order_4_subcontract_master
integer y = 1568
integer width = 4535
integer height = 728
string dataobject = "d_mat_purchase_order_4_subcontract_mst"
...
if  dwo.name = 'line_type' then 	
	...
	if data = 'M' OR data = 'S' then
	else
		Messagebox("Notify" , "Your line type must select M or S" )
		return 2
	end if
...
if dwo.name = 'b_origin_mfs' then 

	openwithparm( w_mat_free_item_inventory_popup , string(this.object.supplier_code[row] ))
	
	if gst_return.gvb_return = false then 
	else
		
		//=================================
		// $$HEX7$$acc009ae98ccacc7e0ac58c72000$$ENDHEX$$material mfs $$HEX8$$7cb920001cbcfcc8dcc2d0c594b22000$$ENDHEX$$origin mfs $$HEX11$$5cb82000c0c915c858d5ecc520001cbcfcc85cd5e4b2$$ENDHEX$$
		// $$HEX16$$5cc6d0b058d574ba2000acc009ae98ccd0c51cc12000e4b4b4c52cc64cb52000$$ENDHEX$$material mfs $$HEX23$$94b22000c8c05cb874c7200080bdecc51cb4200018bc1cc888d474c72000acc0a9c658d58cac200018b4e0ac2000$$ENDHEX$$
		// origin mfs $$HEX32$$94b22000d0c698b72000acc009ae98ccd0c5200088c758b3200090c7acc77cb9200028cc10ac200060d54cb5200070c874ac3cc75cb82000acc0a9c61cb4e4b2$$ENDHEX$$.
		// $$HEX22$$74c783ac40c72000d0c6acc7ccb8200034bbc1c0200030aec0d085c7e0acdcc2d0c5200001c8a9c61cb4e4b2$$ENDHEX$$.
		//=================================
		this.object.origin_mfs[row] = message.stringparm
		
	end if
	
end if 

if dwo.name = 'b_subcontract_invoice_no' then
   openwithparm( w_mat_free_subcontract_invoice_no_popup , string(this.object.supplier_code[row] ))
	
	if gst_return.gvb_return = false then 
	else
		
		this.object.subcontract_invoice_no[row] = message.stringparm
...
type dw_1 from w_main_root`dw_1 within w_mat_purchase_order_4_subcontract_master
integer y = 548
integer width = 4544
integer height = 1012
boolean titlebar = true
string title = "Purchase Order for Subcontract List"
string dataobject = "d_mat_purchase_order_4_subcontract_lst"
end type
...
type uo_tabpages from w_main_root`uo_tabpages within w_mat_purchase_order_4_subcontract_master
end type
...
integer taborder = 50
boolean bringtotop = true
string text = "Show Free Issue List"
end type

event clicked;call super::clicked;openwithparm(w_mat_unit_price_4_free_purchase_order_popup , dw_2)
