HA$PBExportHeader$w_mcn_sample_input_history_master.srw
$PBExportComments$SAMPLE input history
forward
global type w_mcn_sample_input_history_master from w_main_root
end type
type sle_jig_lot_no from so_singlelineedit within w_mcn_sample_input_history_master
end type
type st_1 from so_statictext within w_mcn_sample_input_history_master
end type
type sle_model_item from so_singlelineedit within w_mcn_sample_input_history_master
end type
type st_3 from so_statictext within w_mcn_sample_input_history_master
end type
type ddlb_jig_type from uo_basecode within w_mcn_sample_input_history_master
end type
type st_6 from so_statictext within w_mcn_sample_input_history_master
end type
type ddlb_line_code from uo_line_code within w_mcn_sample_input_history_master
end type
type st_line_code from statictext within w_mcn_sample_input_history_master
end type
type st_4 from so_statictext within w_mcn_sample_input_history_master
end type
type uo_dateset from uo_ymd_calendar within w_mcn_sample_input_history_master
end type
type uo_dateend from uo_ymd_calendar within w_mcn_sample_input_history_master
end type
type gb_1 from groupbox within w_mcn_sample_input_history_master
end type
end forward
...
global w_mcn_sample_input_history_master w_mcn_sample_input_history_master

on w_mcn_sample_input_history_master.create
int iCurrent
call super::create
...
on w_mcn_sample_input_history_master.destroy
call super::destroy
...
type dw_5 from w_main_root`dw_5 within w_mcn_sample_input_history_master
integer y = 288
end type

type dw_4 from w_main_root`dw_4 within w_mcn_sample_input_history_master
integer y = 288
integer taborder = 80
end type

type dw_3 from w_main_root`dw_3 within w_mcn_sample_input_history_master
integer x = 2126
integer y = 1676
integer width = 2478
integer height = 992
...
type dw_2 from w_main_root`dw_2 within w_mcn_sample_input_history_master
integer x = 5
integer y = 1676
integer width = 2112
integer height = 992
...
type dw_1 from w_main_root`dw_1 within w_mcn_sample_input_history_master
integer y = 292
integer width = 4626
integer height = 2384
boolean titlebar = true
string title = "Sample Mater Input History"
string dataobject = "d_mcn_sample_input_history_query"
end type
...
type uo_tabpages from w_main_root`uo_tabpages within w_mcn_sample_input_history_master
end type
