HA$PBExportHeader$uo_code_master_type.sru
forward
global type uo_code_master_type from dropdownlistbox
end type
type st_vendor from structure within uo_code_master_type
end type
end forward
...
global uo_code_master_type uo_code_master_type
...
on uo_code_master_type.create
end on

on uo_code_master_type.destroy
end on
