HA$PBExportHeader$w_smt_upload_nc_master.srw
$PBExportComments$$$HEX4$$ddc0b0c0c4ac8dd6$$ENDHEX$$
forward
global type w_smt_upload_nc_master from w_main_root
end type
type st_3 from so_statictext within w_smt_upload_nc_master
end type
type cb_1 from commandbutton within w_smt_upload_nc_master
end type
type sle_lot_name from so_singlelineedit within w_smt_upload_nc_master
end type
type mle_2 from so_multilineedit within w_smt_upload_nc_master
end type
type rb_pana from so_radiobutton within w_smt_upload_nc_master
end type
type rb_smasung from so_radiobutton within w_smt_upload_nc_master
end type
type ddlb_line_code from uo_line_code within w_smt_upload_nc_master
end type
type st_1 from so_statictext within w_smt_upload_nc_master
end type
type ddlb_pcb_item from uo_basecode within w_smt_upload_nc_master
end type
type dw_6 from so_datawindow within w_smt_upload_nc_master
end type
type cb_2 from commandbutton within w_smt_upload_nc_master
end type
type st_status from so_statictext within w_smt_upload_nc_master
end type
type dw_7 from so_datawindow within w_smt_upload_nc_master
end type
type dw_8 from so_datawindow within w_smt_upload_nc_master
end type
type dw_9 from so_datawindow within w_smt_upload_nc_master
end type
type dw_10 from so_datawindow within w_smt_upload_nc_master
end type
type cb_3 from commandbutton within w_smt_upload_nc_master
end type
type ddlb_set_item_code from uo_set_model_name_ddlb within w_smt_upload_nc_master
end type
type st_2 from so_statictext within w_smt_upload_nc_master
end type
type sle_model_name from so_singlelineedit within w_smt_upload_nc_master
end type
type st_4 from so_statictext within w_smt_upload_nc_master
end type
type cb_4 from commandbutton within w_smt_upload_nc_master
end type
type cb_5 from commandbutton within w_smt_upload_nc_master
end type
type cb_6 from commandbutton within w_smt_upload_nc_master
end type
type dw_11 from so_datawindow within w_smt_upload_nc_master
end type
type dw_12 from so_datawindow within w_smt_upload_nc_master
end type
type rb_npm from so_radiobutton within w_smt_upload_nc_master
end type
type ddlb_smt_model_name from uo_smt_model_name_ddlb within w_smt_upload_nc_master
end type
type dw_13 from so_datawindow within w_smt_upload_nc_master
end type
type cbx_mixed from so_checkbox within w_smt_upload_nc_master
end type
type rb_pana_position from so_radiobutton within w_smt_upload_nc_master
end type
type sle_revision from so_singlelineedit within w_smt_upload_nc_master
end type
type st_5 from so_statictext within w_smt_upload_nc_master
end type
type sle_layout_model_name from so_singlelineedit within w_smt_upload_nc_master
end type
type st_6 from so_statictext within w_smt_upload_nc_master
end type
type rb_1 from so_radiobutton within w_smt_upload_nc_master
end type
type dw_14 from so_datawindow within w_smt_upload_nc_master
end type
type cb_7 from commandbutton within w_smt_upload_nc_master
end type
type st_7 from so_statictext within w_smt_upload_nc_master
end type
type ddlb_supplier_code from uo_supplier_name_code within w_smt_upload_nc_master
end type
type gb_1 from so_groupbox within w_smt_upload_nc_master
end type
type gb_2 from so_groupbox within w_smt_upload_nc_master
end type
type gb_3 from so_groupbox within w_smt_upload_nc_master
end type
end forward
...
integer width = 9271
integer height = 2804
string title = "SMT Upload NC Master"
...
global w_smt_upload_nc_master w_smt_upload_nc_master

type variables
string LVS_LINE_CODE , lvs_pcb_item  , lvs_master_model_name , lvs_smt_model_name , lvs_layout_model_name , lvs_supplier_code
end variables
...
public function integer wf_yamaha ()
end prototypes
...
//======================================================
		...
		select n  , pa , pb , plan_date , lot_name from ib_mnt_stockdata order by TO_NUMBER(idnum) ;
		...
		do
			...
			ELSE
				...
				IF mid(lvs_n , 4 ,1 ) <> '0' THEN 
					...
					lvs_table = 'Z' 
					Lvs_address =  'TRAY'+RIGHT(lvs_n , 2 )
	...
	//			from ib_mnt_positiondata
				 FROM  ( SELECT  parts , PU , C  , SIDE
								from ib_mnt_positiondata
							    where pu <> '0'
       						 GROUP BY parts , pu  , C , SIDE )
...
string lvs_no,lvs_REF , lvs_fdr , lvs_partname  , lvs_item_code;
...
//		          replace(substr( partname ,1, 13 ) , '-','')   partname_sub , 
		  ...
		  where substr( fdr , 1,1 ) in ( 'F' , 'R'  , 'T' , 'S' ) 
		 group by 
		      partname,
		//      substr(  partname  , 1 ,  decode (  instr( partname , '-' , 7 , 1 ) , 0  , length( partname) ,  instr( partname , '-' , 7 , 1 ) -1   ) ), 
		      fdr ;
		...
		do
			...
			ELSE
				...
				ELSEIF mid(lvs_fdr , 1 ,1 )  = 'T'  OR mid(lvs_fdr , 1 ,1 )  = 'S'   THEN 					
...
//				where replace(substr( partname ,1, 13 ) , '-','') = :lvs_partname  ;		
			 ...
			 SELECT listagg(REF, ',' ) within GROUP(ORDER BY REF)   , count(DISTINCT REF)
				  into   :lvs_location_infor , :lvi_item_unit_qty
				from ( select ref ,  partname 
						  from ib_mnt_step_infor 
						  where  partname  = :lvs_partname 
						      and fdr = :lvs_fdr
						 group by ref , partname
						 ) 
				where partname  = :lvs_partname  ;		
				...
				where supplier_code = :lvs_supplier_code
					  and (item_code = :lvs_partname 
					     or part_no = :lvs_partname 
						 or instr( part_no , :lvs_partname) > 0  
					     or item_spec = :lvs_partname 
					     or instr( item_spec , :lvs_partname) > 0   
						 );
				...
				ELSE
						dw_1.object.partname[row] = lvs_item_code
						dw_1.object.chipname[row] = lvs_item_code
	...
	st_status.text = "File Open : "+is_fullname 
		...
		//=========================================
		     ...
		     if li_FileNum < 0 then 
				...
				MESSAGEBOX("ERROR" , "File Open Error" )
				rollback;
				return -1				
			end if 		
			...
			do
				li_eof = FileReadEx (li_FileNum, ls_text ) 
				  ...
				  if li_eof < 0 then 
					...
					MESSAGEBOX("ERROR" , "File Read Error : " +is_fullname+" EOF="+ STRING(li_eof))
				//	rollback;
				//	return -1				
		...
		//===========================================================================
			...
			if ls_text = '[PartsLIB]' AND lvs_PartsLIB_yn = 'N' then
				...
				do while ( mid(ls_text , 1 ,1) <> '[' and li_eof2 <> 0 )
					...
					lvl_error= dw_7.importstring( f_replace_string( ls_text ,' ' , '~t' ) +"~t"+string(today() ,'yyyymmdd')+"~t"+lvs_lot_name ) 
					if lvl_error < 0 then
						FileClose (li_FileNum)  
						messagebox("Error" , "Part Lib Import Error" ) 
						return -1
					end if 
		...
		do
			...
			if lvs_pa <> '0' and lvs_pb <> '0' then  //$$HEX3$$91c5bdca2000$$ENDHEX$$
			  ...
			  //==============================================	
				...
				if lvs_partname1 = '' or isnull(lvs_partname1) then 
					close cl_stock ;
					rollback ;
					Messagebox("Error" , "Part Lib Not Found IDNUM(A)="+ lvs_pa ) 
					exit
				end if ;
			  ...
			  //==============================================
				...
				if lvs_partname2 = '' or isnull(lvs_partname2) then 
					close cl_stock ;
					rollback ;
					Messagebox("Error" , "Part Lib Not Found IDNUM(B)="+ lvs_pb ) 
					exit
				end if ;			
			...
			elseif lvs_pa = '0' and lvs_pb <> '0' then  //$$HEX4$$24c678b9bdca2000$$ENDHEX$$
				...
				if lvs_partname2 = '' or isnull(lvs_partname2) then 
					close cl_stock ;
					rollback ;
					Messagebox("Error" , "Part Lib Not Found IDNUM(B)="+ lvs_pa ) 
					exit
				end if ;	
...
public function integer wf_yamaha ();integer li_FileNum , li_eof , li_eof2 , lvi_loop
string is_filename , is_fullname , ls_text  , lvs_feeder_type  , lvs_machine_code , lvs_partname
String  LVS_MACHINE_GROUP , LVS_START_TABLE_ID  , lvs_plan_date , lvs_lot_name  , lvs_chipname , lvs_table  , lvs_address , lvs_location_infor
int i , row , lvi_item_unit_qty
		
//string lvs_no,lvs_REF , lvs_fdr ,  ;
...
do 
	...
	if is_fullname  = '' or isnull(is_fullname) then 
		...
		//=========================================
			...
			//$$HEX12$$c0d074c7c0d220007dc7b4c51cc1200034bbdcc220000900$$ENDHEX$$
			li_eof = FileReadEx (li_FileNum, ls_text ) 
		
		//===========================================================================
		//  $$HEX26$$0cd37cc744c720007dc7b4c51cc1200070b374c730d1200008c7c4b3d0c520007cc7e8b2200084c7ecd3b8d220005cd5e4b22000$$ENDHEX$$
		//===========================================================================

				li_eof2 = FileReadEx (li_FileNum, ls_text )
				
				do while ( li_eof2  <> -100 and  li_eof2  <> -1   )
		
					mle_2.text = mle_2.text + ls_text+"~r~n"		
					dw_14.importstring(  ls_text  )
					//	dw_14.importstring( f_replace_string( ls_text ,' ' , '~t' ) +"~t"+string(today() ,'yyyymmdd')+"~t"+lvs_lot_name )
					li_eof2 = FileReadEx (li_FileNum, ls_text )	
				loop  ;
	   ...
	   declare cl_step cursor for 
		 select  trim(to_char(line_code , '00')),
		           substr( machine_code ,-1 ,1 ) , 
				  address , 
				  item_code , 
				  item_spec , 
				  feeder_type , 
		...
		do
			fetch cl_step into :lvs_line_code , :lvs_machine_code ,  :lvs_address , :lvs_partname , :lvs_chipname , :lvs_feeder_type , :lvs_location_infor ,  :lvi_item_unit_qty ;
			...
			if sqlca.sqlcode = 100 then 
				...
				row = dw_1.insertrow(0)
				dw_1.object.plan_date[row] = string(f_sysdate() , 'yyyymmdd') //lvs_plan_date
				dw_1.object.lot_name[row] = LVS_LAYOUT_MODEL_NAME // lvs_lot_name
				dw_1.object.table_id[row] = LVS_START_TABLE_ID // lvs_table
				dw_1.object.address[row] = lvs_address
				dw_1.object.position[row] = ''	
				dw_1.object.partname[row] = lvs_partname
				dw_1.object.chipname[row] = lvs_chipname
				...
				dw_1.object.item_unit_qty[row] = lvi_item_unit_qty
				dw_1.object.machine_code[row] = lvs_line_code+  string( integer(lvs_machine_code) , '00') 
...
on w_smt_upload_nc_master.create
int iCurrent
call super::create
...
this.Control[iCurrent+37]=this.dw_14
this.Control[iCurrent+38]=this.cb_7
this.Control[iCurrent+39]=this.st_7
this.Control[iCurrent+40]=this.ddlb_supplier_code
this.Control[iCurrent+41]=this.gb_1
this.Control[iCurrent+42]=this.gb_2
this.Control[iCurrent+43]=this.gb_3
end on

on w_smt_upload_nc_master.destroy
call super::destroy
destroy(this.st_3)
destroy(this.cb_1)
...
dw_14.settransobject( sqlca) //position data
end event

event resize;call super::resize;st_status.width = dw_1.width + dw_2.width
end event

type dw_5 from w_main_root`dw_5 within w_smt_upload_nc_master
integer y = 1092
integer width = 2729
integer height = 744
...
type dw_4 from w_main_root`dw_4 within w_smt_upload_nc_master
integer x = 2743
integer y = 1856
integer width = 2629
integer height = 744
...
type dw_3 from w_main_root`dw_3 within w_smt_upload_nc_master
integer y = 1856
integer width = 2734
integer height = 744
boolean titlebar = true
...
type dw_2 from w_main_root`dw_2 within w_smt_upload_nc_master
integer x = 2743
integer y = 1096
integer width = 2633
integer height = 744
...
type dw_1 from w_main_root`dw_1 within w_smt_upload_nc_master
...
type uo_tabpages from w_main_root`uo_tabpages within w_smt_upload_nc_master
end type
...
if lvs_line_code = '' or lvs_line_code = '%' or LVS_SMT_MODEL_NAME = '' or isnull(LVS_SMT_MODEL_NAME) or LVS_SMT_MODEL_NAME = '%' or lvs_pcb_item = '' or lvs_pcb_item  = '%' or LVS_LAYOUT_MODEL_NAME = '' or isnull(LVS_LAYOUT_MODEL_NAME) then 
...
elseif rb_npm.checked = true then 
	wf_npm( )
elseif rb_smasung.checked = true then 
	wf_samsung( )
else
	wf_yamaha() 
end if 
  ...
  select  model_name , //parent_item_code,
    //        SUBSTR( partname , 1 ,  decode(  instr( partname , '-' , 7 , 1 ) , 0 , length(partname)  , instr( partname , '-' , 7 , 1 )  -1  )   )  , //child_item_code,
		...
		1 , //bom_level,
            ...
            0 , //bom_work_no,
            'T' , //item_type,
			 f_get_line_type_from_item(	partname , :gvi_organization_id ) ,
...
LVS_SMT_MODEL_NAME = this.GETCODE() 
...
boolean titlebar = true
string title = "YMAHA"
string dataobject = "d_yamaha_csv"
boolean hscrollbar = true
boolean vscrollbar = true
boolean hsplitscroll = true
end type
...
long i
string lvs_part_no , lvs_item_code 
lvs_supplier_code = ddlb_supplier_code.getcode()

do
	i++
	
	lvs_part_no = dw_1.object.partname[i]
	...
	if lvs_item_code = '' or isnull(lvs_item_code) then 
		...
		dw_1.object.partname[i] = lvs_item_code
		dw_1.object.chipname[i] = lvs_item_code	
	end if 
	dw_1.accepttext() 
