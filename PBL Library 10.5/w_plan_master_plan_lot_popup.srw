HA$PBExportHeader$w_plan_master_plan_lot_popup.srw
$PBExportComments$Lqc Lot Divide Popup
forward
global type w_plan_master_plan_lot_popup from w_none_dw_popup_root
end type
type cb_2 from so_commandbutton within w_plan_master_plan_lot_popup
end type
type em_origin from so_editmask within w_plan_master_plan_lot_popup
end type
type st_origin from so_statictext within w_plan_master_plan_lot_popup
end type
type em_new from so_editmask within w_plan_master_plan_lot_popup
end type
type st_new from so_statictext within w_plan_master_plan_lot_popup
end type
type em_result from so_editmask within w_plan_master_plan_lot_popup
end type
type em_count from so_editmask within w_plan_master_plan_lot_popup
end type
type st_1 from so_statictext within w_plan_master_plan_lot_popup
end type
type gb_1 from so_groupbox within w_plan_master_plan_lot_popup
end type
end forward
...
global w_plan_master_plan_lot_popup w_plan_master_plan_lot_popup

on w_plan_master_plan_lot_popup.create
int iCurrent
call super::create
...
on w_plan_master_plan_lot_popup.destroy
call super::destroy
destroy(this.cb_2)
...
type p_title from w_none_dw_popup_root`p_title within w_plan_master_plan_lot_popup
integer width = 1874
end type

type cb_close from w_none_dw_popup_root`cb_close within w_plan_master_plan_lot_popup
...
type st_msg from w_none_dw_popup_root`st_msg within w_plan_master_plan_lot_popup
boolean visible = true
integer y = 0
end type
...
if  truncate(double(em_origin.text) / double(em_new.text) , 0 )  < long(em_count.text) then 
	//MES SAGEBOX("Notify" , "Lot Count Invalid")
	f_msg("Lot Count Invalid",'P')
	return
end if
