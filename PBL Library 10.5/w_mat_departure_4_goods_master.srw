HA$PBExportHeader$w_mat_departure_4_goods_master.srw
$PBExportComments$Material Departure Master
forward
global type w_mat_departure_4_goods_master from w_main_root
end type
type uo_dateset from uo_ymd_calendar within w_mat_departure_4_goods_master
end type
type uo_dateend from uo_ymd_calendar within w_mat_departure_4_goods_master
end type
type ddlb_item_code from uo_item_code within w_mat_departure_4_goods_master
end type
type st_3 from so_statictext within w_mat_departure_4_goods_master
end type
type st_4 from so_statictext within w_mat_departure_4_goods_master
end type
type rb_purchase from so_radiobutton within w_mat_departure_4_goods_master
end type
type rb_departure from so_radiobutton within w_mat_departure_4_goods_master
end type
type ddlb_supplier_code from uo_supplier_code within w_mat_departure_4_goods_master
end type
type st_1 from so_statictext within w_mat_departure_4_goods_master
end type
type tab_1 from tab within w_mat_departure_4_goods_master
end type
...
type st_5 from so_statictext within w_mat_departure_4_goods_master
end type
type st_14 from so_statictext within w_mat_departure_4_goods_master
end type
type sle_item_name from so_singlelineedit within w_mat_departure_4_goods_master
end type
type sle_1 from so_singlelineedit within w_mat_departure_4_goods_master
end type
type gb_1 from so_groupbox within w_mat_departure_4_goods_master
end type
type gb_2 from so_groupbox within w_mat_departure_4_goods_master
end type
end forward
...
integer width = 4608
integer height = 3384
string title = "Goods Arrival Master"
...
global w_mat_departure_4_goods_master w_mat_departure_4_goods_master

type variables
string ivs_preview_yn = 'N'
end variables

on w_mat_departure_4_goods_master.create
int iCurrent
call super::create
...
on w_mat_departure_4_goods_master.destroy
call super::destroy
...
choose case gvs_ue_data_control
	...
	case 'RETRIEVE'
			...
			if    rb_purchase.checked   then 
				...
				dw_4.retrieve(ddlb_item_code.text() + '%',  ddlb_supplier_code.text + '%' , uo_dateset.text() , uo_dateend.text(),  gvi_organization_id)
			end if 
...
type dw_5 from w_main_root`dw_5 within w_mat_departure_4_goods_master
integer y = 588
integer width = 4544
integer height = 1104
...
type dw_4 from w_main_root`dw_4 within w_mat_departure_4_goods_master
integer y = 588
integer width = 4544
integer height = 1104
boolean titlebar = true
string title = "Goods Departure List"
string dataobject = "d_mat_departure_4_goods_lst"
...
type dw_3 from w_main_root`dw_3 within w_mat_departure_4_goods_master
integer x = 2272
integer y = 1696
integer width = 2267
integer height = 788
...
type dw_2 from w_main_root`dw_2 within w_mat_departure_4_goods_master
integer y = 1696
integer width = 2267
integer height = 788
boolean titlebar = true
...
type dw_1 from w_main_root`dw_1 within w_mat_departure_4_goods_master
integer y = 588
integer width = 4544
integer height = 1104
boolean titlebar = true
string title = "Goods Purchase Order List"
string dataobject = "d_mat_purchase_order_4_goods_arrival_lst"
end type

event dw_1::itemchanged;call super::itemchanged;if dwo.name = 'order_remain_qty' then 
...
type uo_tabpages from w_main_root`uo_tabpages within w_mat_departure_4_goods_master
end type
...
this.Control[]={this.cbx_ignore_buy_price,&
...
for i = 1 to dw_1.rowcount()
	...
	//========================================
	dw_1.object.arrival_qty[i] = lvl_arrival_qty + lvl_order_remain_qty
