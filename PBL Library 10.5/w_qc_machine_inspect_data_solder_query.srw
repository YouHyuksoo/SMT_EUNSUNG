HA$PBExportHeader$w_qc_machine_inspect_data_solder_query.srw
$PBExportComments$$$HEX3$$30bcb8d2a8b0$$ENDHEX$$
forward
global type w_qc_machine_inspect_data_solder_query from w_main_root
end type
type st_label from so_statictext within w_qc_machine_inspect_data_solder_query
end type
type st_4 from so_statictext within w_qc_machine_inspect_data_solder_query
end type
type uo_dateset from uo_ymd_calendar within w_qc_machine_inspect_data_solder_query
end type
type uo_dateend from uo_ymd_calendar within w_qc_machine_inspect_data_solder_query
end type
type st_1 from so_statictext within w_qc_machine_inspect_data_solder_query
end type
type sle_model from singlelineedit within w_qc_machine_inspect_data_solder_query
end type
type gb_3 from so_groupbox within w_qc_machine_inspect_data_solder_query
end type
end forward
...
integer width = 5737
integer height = 2840
string title = "Solder Viscosity Result Query"
...
global w_qc_machine_inspect_data_solder_query w_qc_machine_inspect_data_solder_query
...
on w_qc_machine_inspect_data_solder_query.create
int iCurrent
call super::create
...
this.Control[iCurrent+6]=this.sle_model
this.Control[iCurrent+7]=this.gb_3
end on

on w_qc_machine_inspect_data_solder_query.destroy
call super::destroy
...
choose case gvs_ue_data_control
	...
	case 'RETRIEVE'
			...
			dw_1.retrieve(   uo_dateset.text( ) , uo_dateend.text( ) , sle_model.text+'%' )
...
type dw_5 from w_main_root`dw_5 within w_qc_machine_inspect_data_solder_query
integer y = 340
integer width = 4242
integer height = 1040
integer taborder = 0
...
type dw_4 from w_main_root`dw_4 within w_qc_machine_inspect_data_solder_query
integer y = 340
integer width = 4242
integer height = 1040
integer taborder = 0
...
type dw_3 from w_main_root`dw_3 within w_qc_machine_inspect_data_solder_query
integer y = 340
integer width = 4238
integer height = 1040
integer taborder = 0
...
type dw_2 from w_main_root`dw_2 within w_qc_machine_inspect_data_solder_query
integer y = 340
integer width = 4242
integer height = 1040
integer taborder = 0
...
type dw_1 from w_main_root`dw_1 within w_qc_machine_inspect_data_solder_query
integer y = 340
integer width = 4969
integer height = 2224
integer taborder = 0
boolean titlebar = true
string title = "Viscosity Result"
string dataobject = "d_qc_machine_inspect_data_lst_solder"
end type
...
type uo_tabpages from w_main_root`uo_tabpages within w_qc_machine_inspect_data_solder_query
integer taborder = 0
end type
