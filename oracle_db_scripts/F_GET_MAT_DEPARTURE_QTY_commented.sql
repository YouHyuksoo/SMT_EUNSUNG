CREATE OR REPLACE FUNCTION
   ...
   * ================================================================
   * 사용 예시:
   *   SELECT F_GET_MAT_DEPARTURE_QTY(...) FROM DUAL;
   * ================================================================ */
 "F_GET_MAT_DEPARTURE_QTY" (p_item_code IN VARCHAR2,p_line_type IN varchar2 , p_org IN NUMBER)
   RETURN NUMBER
IS
