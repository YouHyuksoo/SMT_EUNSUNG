CREATE OR REPLACE FUNCTION
   ...
   *   ISAL_SHIPPING_LOT_MASTER - LOT 관련 값 조회 또는 참조
   * ================================================================
   * [AI 분석] 예외 처리:
   ...
   * ================================================================
   * 사용 예시:
   *   SELECT F_GET_SET_ITEM_BY_LOT_NO(...) FROM DUAL;
   * ================================================================ */
 "F_GET_SET_ITEM_BY_LOT_NO" (p_lot_no IN VARCHAR2)
    RETURN VARCHAR2
IS
