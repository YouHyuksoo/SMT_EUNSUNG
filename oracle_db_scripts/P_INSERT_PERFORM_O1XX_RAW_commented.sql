CREATE OR REPLACE PROCEDURE P_INSERT_PERFORM_O1XX_RAW (
  /* ================================================================
   * 프로시저명  : P_INSERT_PERFORM_O1XX_RAW
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2020-07-30
   * 수정이력:
   ...
   *   IQ_MACHINE_INSPECT_DATA_O1XX - 원본 로직 참조 테이블
   * ================================================================
   * [AI 분석] 호출 객체:
   *   F_GET_RUN_NO_BY_PID
   *   P_DATA
   ...
   * ================================================================
   * 사용 예시:
   *   EXEC P_INSERT_PERFORM_O1XX_RAW(...)
   * ================================================================ */
