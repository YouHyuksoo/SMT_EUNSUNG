CREATE OR REPLACE TRIGGER "INFINITY21_JSMES"
  /* ================================================================
   * 트리거명  : TRG_MAT_RECEIPT_LEDGER_REGEN
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2026-07-02
   * 수정이력:
   ...
   * ================================================================
   * [AI 분석] 기능 설명:
   *   IM_ITEM_RECEIPT_LEDGER_REGEN 테이블의 INSERT 발생 시 재고/수불 관련 후속 데이터를 자동 정리한다.
   ...
   * ================================================================
   * [AI 분석] 대상 객체:
   *   IM_ITEM_RECEIPT_LEDGER_REGEN - 트리거가 걸린 테이블/뷰
   * ================================================================
   * [AI 분석] OLD/NEW 사용:
   ...
   * ================================================================
   * [AI 분석] 참조 테이블:
   *   IM_ITEM_RECEIPT_LEDGER_REGEN - 품목 / 입고 / 수불장 관련 트리거 대상 테이블
   ...
   * ================================================================
   * 검증 방법:
   *   SELECT status FROM user_objects WHERE object_type = 'TRIGGER' AND object_name = 'TRG_MAT_RECEIPT_LEDGER_REGEN';
   *   SELECT * FROM user_errors WHERE type = 'TRIGGER' AND name = 'TRG_MAT_RECEIPT_LEDGER_REGEN';
   *   주의: 검증 목적으로 대상 테이블에 DML을 실행하지 않는다.
   * ================================================================ */
."TRG_MAT_RECEIPT_LEDGER_REGEN" 
 BEFORE
  INSERT
