CREATE OR REPLACE FUNCTION
  /* ================================================================
   * 함수명  : F_GET_CREATE_CELLBIZ_BARCODE_N
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2026-07-02
   * 수정이력:
   ...
   *   P_SCAN_BARCODE  (IN, varchar2) - 바코드
   * ================================================================
   * [AI 분석] 반환값:
   *   varchar2 - 함수 처리 결과값
   * ================================================================
   ...
   * ================================================================
   * [AI 분석] 호출 객체:
   *   P_CREATE_CELL_BIZ_BARCODE_NN - 관련 업무 함수 호출
   * ================================================================
   * [AI 분석] 예외 처리:
   ...
   * ================================================================
   * 사용 예시:
   *   SELECT F_GET_CREATE_CELLBIZ_BARCODE_N(...) FROM DUAL;
   * ================================================================ */
 F_GET_CREATE_CELLBIZ_BARCODE_N (p_model varchar2, p_suffix varchar2, p_item varchar2,  p_workdate date, p_line varchar2, p_workstage varchar2,  p_pack_unit_qty number, p_scan_barcode varchar2 
                                                          )
return varchar2 is
