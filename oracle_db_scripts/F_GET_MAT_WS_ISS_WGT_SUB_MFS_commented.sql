CREATE OR REPLACE FUNCTION
  /* ================================================================
   * 함수명  : F_GET_MAT_WS_ISS_WGT_SUB_MFS
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2026-07-02
   * 수정이력:
   ...
   *   P_RECEIPT_DATE  (IN, DATE) - 일자 관련 값
   *   P_RECEIPT_SEQUENCE  (IN, NUMBER) - 함수 입력값
   ...
   * ================================================================
   * 사용 예시:
   *   SELECT F_GET_MAT_WS_ISS_WGT_SUB_MFS(...) FROM DUAL;
   * ================================================================ */
 "F_GET_MAT_WS_ISS_WGT_SUB_MFS" (
