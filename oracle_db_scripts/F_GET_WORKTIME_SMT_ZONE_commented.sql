CREATE OR REPLACE FUNCTION
   ...
   * ================================================================
   * 사용 예시:
   *   SELECT F_GET_WORKTIME_SMT_ZONE(...) FROM DUAL;
   * ================================================================ */
 "F_GET_WORKTIME_SMT_ZONE" (p_date varchar2,
                                               p_time varchar2,
                                               p_option varchar2 default 'ZONE' ) return varchar2 is
  Result varchar2(5);
  LVS_DATE VARCHAR(8);
begin
