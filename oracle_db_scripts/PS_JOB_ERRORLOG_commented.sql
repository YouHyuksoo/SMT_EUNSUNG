CREATE OR REPLACE PROCEDURE "PS_JOB_ERRORLOG" (
  /* ================================================================
   * 프로시저명  : PS_JOB_ERRORLOG
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2020-08-11
   * 수정이력:
   *   2020-08-11 - 지성솔루션컨설팅 - 최초 작성
   *   2026-07-01 - AI(Codex)       - 한글 주석 자동 추가
   * ================================================================
   * [AI 분석] 기능 설명:
   *   배치 작업 오류 정보를 TB_ADM_BATCHJOBERRORLOG에 기록한다.
   *   작업 번호, 조직, 프로세스명, 오브젝트명, 비고를 Error 상태 로그로 저장한다.
   *   자율 트랜잭션으로 처리되어 호출 트랜잭션과 독립적으로 COMMIT 또는 ROLLBACK된다.
   * ================================================================
   * [AI 분석] 파라미터:
   ...
   * ================================================================
   * [AI 분석] 참조 테이블:
   *   TB_ADM_BATCHJOBERRORLOG - 배치 작업 오류 로그 테이블
   * ================================================================
   * [AI 분석] 예외 처리:
   ...
   * ================================================================
   * 사용 예시:
   *   EXEC PS_JOB_ERRORLOG(1, 1, 'PROC', 'OBJECT', 'ERROR', 'USER')
   * ================================================================ */
 p_work_no NUMBER
    ...
    BEGIN
        ...
        -- [AI] 오류 로그 등록자를 고정 값으로 설정한다.
        v_work_man  := 'Logger';

        -- [AI] 배치 작업 오류 정보를 로그 테이블에 기록한다.
