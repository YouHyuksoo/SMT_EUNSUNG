CREATE OR REPLACE PROCEDURE "P_PRODUCT_FG_PALLETIZING" (p_pallet  varchar2,
  /* ================================================================
   * 프로시저명  : P_PRODUCT_FG_PALLETIZING
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2017-08-04
   * 수정이력:
   *   2017-08-04 - 지성솔루션컨설팅 - 최초 작성
   ...
   *   P_NG_MESSGAE - 원본 선언부 기준 입력/출력 파라미터
   *   P_OK_MESSAGE - 원본 선언부 기준 입력/출력 파라미터
   *   PALLET_FLAG - 원본 선언부 기준 입력/출력 파라미터
   *   PALLET_DATE - 원본 선언부 기준 입력/출력 파라미터
   *   PALLET_QTY - 원본 선언부 기준 입력/출력 파라미터
   *   PALLET_TYPE - 원본 선언부 기준 입력/출력 파라미터
   * ================================================================
   * [AI 분석] 참조 테이블:
   ...
   * ================================================================ */
    ...
    ****************************************************/
    ...
    lvl_stock_qty     number      ;  -- [AI] 내부 처리용 변수
    ...
    lvs_stock_pallet  varchar2(30); -- [AI] 내부 처리용 변수
