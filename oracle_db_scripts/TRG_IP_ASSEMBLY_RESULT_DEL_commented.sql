CREATE OR REPLACE TRIGGER "INFINITY21_JSMES"."TRG_IP_ASSEMBLY_RESULT_DEL" 
 AFTER
  DELETE
...
BEGIN
    /* ================================================================
     * 트리거명  : TRG_IP_ASSEMBLY_RESULT_DEL
     * 작성일  : 2026-07-02
     * 수정이력: 2026-07-02 - AI(Codex) - 한글 주석 자동 추가
     * ================================================================
     * [AI 분석] 기능 설명:
     *   IP_ASSEMBLY_RESULT 테이블의 DELETE 이벤트 발생 시 원본 로직에 정의된 자동 처리를 수행한다.
     * ================================================================
     * [AI 분석] 발화 조건:
     ...
     * ================================================================
     * [AI 분석] OLD/NEW 사용:
     *   :OLD - PLAN_DATE, PLAN_DATE_SEQUENCE, ORGANIZATION_ID, PRODUCT_ACTUAL_QTY, ITEM_CODE, LINE_CODE, WORKSTAGE_CODE, MACHINE_CODE, MOLD_CODE, MOLD_VERSION 변경 전 값 참조
     * ================================================================
     * [AI 분석] 예외 처리:
     *   원본 EXCEPTION 블록 기준으로 오류를 처리한다.
     * ================================================================
     * [AI 분석] 복잡도:
     *   조건 분기: IF 8회 / 반복문: 0회 / DML: SELECT 4회, INSERT 1회, UPDATE 5회, DELETE 1회
     * ================================================================
