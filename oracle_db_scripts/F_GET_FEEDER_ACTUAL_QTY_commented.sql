CREATE OR REPLACE FUNCTION
   ...
   * ================================================================
   * 사용 예시:
   *   SELECT F_GET_FEEDER_ACTUAL_QTY(...) FROM DUAL;
   * ================================================================ */
 "F_GET_FEEDER_ACTUAL_QTY" (
...
BEGIN
   ...
   SELECT SUM (NVL (PRODUCT_ACTUAL_QTY, 0))
     INTO LVL_RETURN
