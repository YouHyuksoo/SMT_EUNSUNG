CREATE OR REPLACE FUNCTION
  /* ================================================================
   * 함수명  : F_GET_MCN_TOTAL_TIME_BY_DATE
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2026-07-02
   * 수정이력:
   ...
   * ================================================================
   * 사용 예시:
   *   SELECT F_GET_MCN_TOTAL_TIME_BY_DATE(...) FROM DUAL;
   * ================================================================ */
 "F_GET_MCN_TOTAL_TIME_BY_DATE" (p_machine_code IN VARCHAR2, p_date in date , p_org IN NUMBER)
   RETURN NUMBER
IS
   lvf_op_time   NUMBER;
BEGIN
