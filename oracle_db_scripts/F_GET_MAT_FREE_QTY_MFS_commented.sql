CREATE OR REPLACE FUNCTION
   ...
   * ================================================================
   * [AI 분석] 파라미터:
   *   P_MATERIAL_MFS  (IN, VARCHAR) - 제조/공급 구분
   ...
   * ================================================================
   * [AI 분석] 참조 테이블:
   *   IM_ITEM_FREE_INVENTORY - 품목 / 재고 관련 값 조회 또는 참조
   * ================================================================
   * [AI 분석] 예외 처리:
   ...
   * ================================================================
   * 사용 예시:
   *   SELECT F_GET_MAT_FREE_QTY_MFS(...) FROM DUAL;
   * ================================================================ */
 "F_GET_MAT_FREE_QTY_MFS" (
