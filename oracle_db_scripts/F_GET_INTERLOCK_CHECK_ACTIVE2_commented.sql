CREATE OR REPLACE FUNCTION
  /* ================================================================
   * 함수명  : F_GET_INTERLOCK_CHECK_ACTIVE2
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2026-07-02
   * 수정이력:
   ...
   * ================================================================
   * 사용 예시:
   *   SELECT F_GET_INTERLOCK_CHECK_ACTIVE2(...) FROM DUAL;
   * ================================================================ */
 "F_GET_INTERLOCK_CHECK_ACTIVE2" ( p_line_code      IN VARCHAR2,
    ...
    BEGIN
        SELECT  NVL( COUNT(SERIAL_NO) , 0)
         ...
         WHERE  LINE_CODE = p_line_code
           ...
           AND  RECEIPT_DATE   >= lvd_date --TO_DATE (TO_CHAR (lvd_date, 'YYYYMMDD') || '0820', 'YYYYMMDDHH24MI')
