PROCEDURE "P_PRODUCT_FG_RECEIPT" (p_barcode varchar2, p_location varchar2,  p_txn number,  p_commit varchar2, p_out out varchar2, p_msg out varchar2) is
   /****************************************************
    * 제품 입고
