PROCEDURE "P_CREATE_CELL_BIZ_BARCODE" (p_model varchar2, p_suffix varchar2, p_item varchar2,  p_date date, p_line varchar2, p_workstage varchar2, p_pack_unit_qty number ,  p_out out varchar2) is
