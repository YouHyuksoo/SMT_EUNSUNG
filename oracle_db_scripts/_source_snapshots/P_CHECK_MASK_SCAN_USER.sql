PROCEDURE p_check_mask_scan_user (
...
IS
   ...
   lvs_check_status       VARCHAR2 (1);
   lvi_cnt                NUMBER;
   lvs_use_status         varchar2(1) ;
   ...
   lvs_last_mask_lot_no2 varchar2(50) ;

   lvs_set_mask_lot_no  varchar2(50) ;
   lvs_set_mask_lot_no2 varchar2(50) ;   
   
   lvs_line_run_no       VARCHAR2 (50);
   lvs_line_pcb_item     VARCHAR2 (50);
   lvs_mask_pcb_item     VARCHAR2 (50);
   lvs_mask_model_name   VARCHAR2 (50);
