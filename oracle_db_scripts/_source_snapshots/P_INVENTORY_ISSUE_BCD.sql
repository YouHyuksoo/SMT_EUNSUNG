PROCEDURE "P_INVENTORY_ISSUE_BCD" (
...
IS
   ...
   LVS_SLIP_NO                 VARCHAR2 (30);
   LVS_SUPPLIER_CODE           VARCHAR2 (30);
   LVS_SUPPLIER                VARCHAR2 (30);
   LVS_ISSUE_COMPARE_YN        VARCHAR2 (10);
   LVS_receipt_COMPARE_YN      VARCHAR2 (10);
   LVL_MSL_PASSED_TIME         NUMBER;
   LVDT_RECEIPT_COMPARE_DATE   DATE;
   LVS_LABEL_TYPE              VARCHAR2 (10);
   LVI_FIFO_COUNT              NUMBER;
   LVS_MAX_LOT_NO              VARCHAR2 (30);
   LVI_REQUEST_COUNT           NUMBER;
   LVL_SCAN_QTY                NUMBER;
   LVL_SEL_COUNT               NUMBER;
   LVS_BARCODE_INPUT           VARCHAR2 (100);
