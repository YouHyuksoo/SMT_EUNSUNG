FUNCTION "F_GET_MANUFACTURE_FROM_BARCODE" (p_barcode IN VARCHAR2)
/* Formatted on 2015-06-20 16:16:44 (QP5 v5.126) */
    RETURN VARCHAR2
IS
    lvi_pos1     NUMBER;
    lvi_pos2     NUMBER;
...
BEGIN
    ...
    THEN
        ...
        lvs_return := SUBSTR (p_barcode, lvi_pos1 + 2, (lvi_pos2 - lvi_pos1) - 1);
    ELSE
        lvs_return := '*';
    END IF;
