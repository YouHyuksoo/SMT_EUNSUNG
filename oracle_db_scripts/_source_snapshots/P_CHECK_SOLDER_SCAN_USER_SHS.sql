PROCEDURE p_check_solder_scan_user_shs (
...
IS
   ...
   lvl_passed_time        NUMBER;
   lvdt_input_date        DATE;
   lvs_line_code          VARCHAR2 (30);
   lvs_model_name         VARCHAR2 (30);
   LVL_TIME_TERM          NUMBER := 300000;

   lvs_solder_lot_no      VARCHAR2 (50);
   lvs_pre_solder         VARCHAR2 (50);
   lvs_solder_type        VARCHAR2 (10);
   lvs_solder_type_cond   VARCHAR2 (10);
   
   lvdt_valid_date        DATE;
   lvl_temp1              NUMBER;
   lvl_temp2              NUMBER;
   
   lv1_viscosity           NUMBER;
   
   lvs_line_solder_type   VARCHAR2 (10);
   lvs_run_no             VARCHAR2 (20);
   
   lvs_last_solder_lot_no      VARCHAR2 (50);
   lvs_last_solder_check_date  DATE;
   
   lvs_fifo_item_barcode       VARCHAR2 (50);   
   lvs_str                     VARCHAR2 (50);   
   
   lvl_dup_count               NUMBER;
   lvl_dup_count2              NUMBER;
