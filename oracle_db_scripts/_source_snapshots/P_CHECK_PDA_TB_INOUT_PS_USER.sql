PROCEDURE P_CHECK_PDA_TB_INOUT_PS_USER (
...
IS
   ...
   LVS_MASTER_MODEL_NAME     VARCHAR2 (50);
   LVS_MODEL_NAME            VARCHAR2 (50);
   LVS_SMT_MODEL_NAME        VARCHAR2 (50);
   LVS_ITEM_CODE             VARCHAR2 (50);
   
   LVS_SET_SMT_MODEL_NAME    VARCHAR2 (50);
   LVS_SET_FEEDER_MODEL_NAME VARCHAR2 (50);
   
   LVS_FEEDER_MODEL_NAME     VARCHAR2 (50);
   LVS_run_model             VARCHAR2 (50);  
   LVS_run_pcb_item          VARCHAR2 (50);  
   LVS_RUN_RUN_NO            VARCHAR2 (50);  
   
   LVS_PCB_ITEM              VARCHAR2 (50);  
   LVS_LAST_MODEL_NAME       VARCHAR2 (50);
   LVS_LAST_RUN_NO           VARCHAR2 (50);
   LVS_LAST_PCB_ITEM         VARCHAR2 (50);
   LVS_SOLDER_TYPE           VARCHAR2 (1);
   LVI_APPLY_MODEL_CHECK NUMBER ;
   LVS_last_mask_lot_no VARCHAR2(50) ;
   
   LVS_CHK_RUN_NO            VARCHAR2 (50); 
