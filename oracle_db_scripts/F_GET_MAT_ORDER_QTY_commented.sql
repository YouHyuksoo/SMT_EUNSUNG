CREATE OR REPLACE FUNCTION
   ...
   * ================================================================
   * [AI 분석] 참조 테이블:
   *   IM_ITEM_PURCHASE_ORDER - 품목 관련 값 조회 또는 참조
   * ================================================================
   * [AI 분석] 예외 처리:
   ...
   * ================================================================
   * 사용 예시:
   *   SELECT F_GET_MAT_ORDER_QTY(...) FROM DUAL;
   * ================================================================ */
 "F_GET_MAT_ORDER_QTY" (
...
BEGIN
   SELECT SUM(order_qty - arrival_qty)
   INTO   lvf_order_qty
   FROM   im_item_purchase_order
   WHERE      item_code = p_item_code
          AND order_qty - arrival_qty <> 0
