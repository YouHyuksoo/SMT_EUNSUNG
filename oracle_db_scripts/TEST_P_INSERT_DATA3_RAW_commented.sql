CREATE OR REPLACE PROCEDURE TEST_P_INSERT_DATA3_RAW (
  /* ================================================================
   * 프로시저명  : TEST_P_INSERT_DATA3_RAW
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2020-05-20
   * 수정이력:
   *   2020-05-20 - 지성솔루션컨설팅 - 최초 작성
...
IS
   ...
   lvs_info5          VARCHAR2 (3000) := ''; -- [AI] 내부 처리용 변수
   li_key_count       int := 0; -- [AI] 내부 처리용 변수

   lvs_info5_str1     VARCHAR2 (100) := ''; -- [AI] 내부 처리용 변수
   lvs_info5_str2     VARCHAR2 (3000) := ''; -- [AI] 내부 처리용 변수
