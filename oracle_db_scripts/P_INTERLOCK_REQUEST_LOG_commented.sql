CREATE OR REPLACE PROCEDURE p_interlock_request_log (
  /* ================================================================
   * 프로시저명  : P_INTERLOCK_REQUEST_LOG
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2016-04-27
   * 수정이력:
   *   2016-04-27 - zethani(지성솔루션컨설팅) - 인터락 요청 로그 작성
   *   2026-07-01 - AI(Codex)       - 한글 주석 자동 추가
   * ================================================================
   * [AI 분석] 기능 설명:
   *   인터락 검사 요청 또는 결과를 IQ_INTERLOCK_REQUEST_LOG에 기록한다.
   *   라인/설비/PID/공정/인터락 유형/반환값을 저장해 인터락 처리 이력을 남긴다.
   *   자율 트랜잭션으로 로그를 즉시 확정한다.
   * ================================================================
   * [AI 분석] 파라미터:
   ...
   * ================================================================
   * [AI 분석] 참조 테이블:
   *   IQ_INTERLOCK_REQUEST_LOG - 인터락 요청/결과 로그 테이블
   * ================================================================
   * [AI 분석] 예외 처리:
   ...
   * ================================================================
   * 사용 예시:
   *   EXEC P_INTERLOCK_REQUEST_LOG('L1', 'MC01', 'PID01', SYSDATE, 'REQ', 'W010', 'Y', 'TYPE')
   * ================================================================ */
 p_line_code        VARCHAR2
    ...
    EXCEPTION
        ...
        WHEN OTHERS THEN
             RAISE_APPLICATION_ERROR (-20003, 'PROC=P_INTERLOCK_REQUEST_LOG()'||' '||SQLERRM);  -- 2016/10/25 SHS, insert ？？ error ？？ user error ？？？
