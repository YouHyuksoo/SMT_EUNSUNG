CREATE OR REPLACE PROCEDURE "P_PRODUCT_FG_MAGAZINE_RECEIPT" (p_barcode varchar2, p_location varchar2,  p_txn number,  p_commit varchar2, p_out out varchar2, p_msg out varchar2) is
  /* ================================================================
   * 프로시저명  : P_PRODUCT_FG_MAGAZINE_RECEIPT
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2020-07-30
   * 수정이력:
   ...
   * ================================================================
   * 사용 예시:
   *   EXEC P_PRODUCT_FG_MAGAZINE_RECEIPT(...)
   * ================================================================ */
   /****************************************************
    * 제품 입고
