CREATE OR REPLACE PROCEDURE P_CREATE_CELL_BIZ_BARCODE_NN (
  /* ================================================================
   * 프로시저명  : P_CREATE_CELL_BIZ_BARCODE_NN
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2020-07-30
   * 수정이력:
   ...
   * ================================================================
   * 사용 예시:
   *   EXEC P_CREATE_CELL_BIZ_BARCODE_NN(...)
   * ================================================================ */
                                                           p_model varchar2, 
                                                           p_suffix varchar2, 
                                                           p_item varchar2,  
  ...
  lvs_yyyymmddnn         varchar2(100); -- [AI] 내부 처리용 변수
