CREATE OR REPLACE PACKAGE BODY
   ...
   * ================================================================
   * [AI 분석] 참조 테이블:
   *   USER_JOBS - 사용자 관련 조회 또는 변경
   *   PUBLIC_DEPENDENCY - 업무 기준/거래 데이터 조회 또는 변경
   *   ALL_OBJECTS - 업무 기준/거래 데이터 조회 또는 변경
   * ================================================================
   * [AI 분석] 예외 처리:
