CREATE OR REPLACE FUNCTION
  /* ================================================================
   * 함수명  : F_GET_PCB_INPUT_QTY_BY_RUN_NO
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2026-07-02
   * 수정이력:
   ...
   *   IQ_MACHINE_INSPECT_DATA_SPI - 검사 관련 값 조회 또는 참조
   * ================================================================
   * [AI 분석] 예외 처리:
   ...
   * ================================================================
   * 사용 예시:
   *   SELECT F_GET_PCB_INPUT_QTY_BY_RUN_NO(...) FROM DUAL;
   * ================================================================ */
 "F_GET_PCB_INPUT_QTY_BY_RUN_NO" (p_run_no IN VARCHAR2, p_org IN NUMBER)
   RETURN NUMBER
IS
   lvl_return   NUMBER;
BEGIN
