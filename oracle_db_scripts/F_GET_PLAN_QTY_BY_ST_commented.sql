CREATE OR REPLACE FUNCTION
   ...
   * ================================================================
   * 사용 예시:
   *   SELECT F_GET_PLAN_QTY_BY_ST(...) FROM DUAL;
   * ================================================================ */
 "F_GET_PLAN_QTY_BY_ST" (
...
BEGIN
   SELECT ( (TO_DATE ('19000101' || END_TIME, 'YYYYMMDDHH24MI')
          ...
          F_GET_MODEL_ST (P_MODEL_NAME,
                          P_lINE_CODE,
                          P_PCB_ITEM,
                          P_ORG),
          DECODE(ATTRIBUTE04, NULL , 1 , 1 + ( ATTRIBUTE04 / 100))
