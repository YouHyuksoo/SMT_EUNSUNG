CREATE OR REPLACE PACKAGE BODY
   ...
   * ================================================================
   * [AI 분석] 참조 테이블:
   *   IP_PRODUCT_MASTER_PLAN - 제품 / 계획 관련 조회 또는 변경
   *   ID_ENG_BOM_TEMP - BOM 관련 조회 또는 변경
   *   IM_ITEM_WORK_ORDER - 품목 관련 조회 또는 변경
   *   ISYS_CONFIG - 환경설정 관련 조회 또는 변경
   *   IP_ASSEMBLY_MASTER_PLAN - 계획 관련 조회 또는 변경
   *   ID_ENG_BOM - BOM 관련 조회 또는 변경
   *   IP_PRODUCT_ROUTING - 제품 관련 조회 또는 변경
   *   ID_ITEM - 품목 관련 조회 또는 변경
   *   IM_ITEM_WORKSTAGE_ISSUE - 품목 / 공정 관련 조회 또는 변경
   *   IP_PRODUCT_WORKSTAGE - 제품 / 공정 관련 조회 또는 변경
   *   IM_ITEM_WORKSTAGE_ISSUE_PLAN - 품목 / 공정 / 계획 관련 조회 또는 변경
   *   IM_ITEM_WORKSTAGE_ISSUE_GEN - 품목 / 공정 관련 조회 또는 변경
   * ================================================================
   * [AI 분석] 예외 처리:
   *   패키지 본문 내 각 PROCEDURE/FUNCTION의 EXCEPTION 블록 또는 호출부 표준 예외 처리를 따른다.
   * ================================================================
   * [AI 분석] 복잡도:
   *   조건 분기: IF 114회 / 반복문: 10회
   *   DML: SELECT 56회, INSERT 19회, UPDATE 10회, DELETE 33회 / 주의: COMMIT 포함
   * ================================================================
   * 사용 예시:
