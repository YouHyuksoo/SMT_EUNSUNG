CREATE OR REPLACE PROCEDURE "P_INTERLOCK_FEEDER_ACTUAL" (
  /* ================================================================
   * 프로시저명  : P_INTERLOCK_FEEDER_ACTUAL
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2020-07-30
   * 수정이력:
   ...
   *   P_ACTUAL_QTY - 원본 선언부 기준 입력/출력 파라미터
   ...
   * ================================================================
   * 사용 예시:
   *   EXEC P_INTERLOCK_FEEDER_ACTUAL(...)
   * ================================================================ */
   ...
   p_out             OUT VARCHAR2)
IS
    lvl_remain          NUMBER; -- [AI] 내부 처리용 변수
    lvl_carrier_qty     NUMBER := 1; -- [AI] 내부 처리용 변수
    LVF_REMAIN_TIME     NUMBER; -- [AI] 내부 처리용 변수
    LVI_ITEM_UNIT_QTY   NUMBER; -- [AI] 내부 처리용 변수
    lvs_location_code   VARCHAR2 (30); -- [AI] 내부 처리용 변수
    LVS_ERRORMSG        VARCHAR2 (1000); -- [AI] 내부 처리용 변수
    lvl_minus_limit     number := 0 ; -- [AI] 내부 처리용 변수
    lvs_config_value    VARCHAR2(100) ; -- [AI] 내부 처리용 변수
    lvs_smt_model_name  varchar2(100) ; -- [AI] 내부 처리용 변수
