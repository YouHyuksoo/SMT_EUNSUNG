CREATE OR REPLACE FUNCTION
   ...
   * ================================================================
   * [AI 분석] 참조 테이블:
   *   IM_ITEM_FBACK_RECEIPT - 품목 관련 값 조회 또는 참조
   * ================================================================
   * [AI 분석] 호출 객체:
   ...
   * ================================================================
   * 사용 예시:
   *   SELECT F_GET_MM_FB_RECEIPT_AMT(...) FROM DUAL;
   * ================================================================ */
 "F_GET_MM_FB_RECEIPT_AMT" (
...
BEGIN
   SELECT SUM( NVL( receipt_amt, 0 ))
    ...
    WHERE item_code = as_item_code
      ...
      AND receipt_date
         BETWEEN F_GET_INVENTORY_CLOSE_DATE( as_yyyymm , 'START' , organization_id )
