CREATE OR REPLACE PROCEDURE P_INSERT_SPI_PARMI_RAW(
  /* ================================================================
   * 프로시저명  : P_INSERT_SPI_PARMI_RAW
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2020-07-30
   * 수정이력:
...
IS
   ...
   lvs_column_count1  VARCHAR2 (20) := ''; -- [AI] 내부 처리용 변수
   lvs_column_count2  VARCHAR2 (20) := ''; -- [AI] 내부 처리용 변수
