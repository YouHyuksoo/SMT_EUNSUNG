CREATE OR REPLACE PROCEDURE "P_CHECK_REEL_TB_SCAN" (
  /* ================================================================
   * 프로시저명  : P_CHECK_REEL_TB_SCAN
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2016-10-17
   * 수정이력:
...
--       END IF;
   ...
   ----------------------------------------------------------------------------------------------       
       ...
       IF ( lvi_row_count = 0 ) THEN
           ...
           p_return := f_msg('[REEL] 출고된 자재 바코드가 아닙니다.', 'K', 1) ; --'00 'Our Barcode Invalid. '
           p_sequence := '' ;
           RETURN;
