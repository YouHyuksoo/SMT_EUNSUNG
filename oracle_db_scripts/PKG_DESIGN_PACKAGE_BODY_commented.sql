CREATE OR REPLACE PACKAGE BODY
   ...
   *   ID_ENG_BOM_WORKSPACE - BOM 관련 조회 또는 변경
   *   ID_ENG_BOM_ECO_WORKSPACE - BOM 관련 조회 또는 변경
   *   ID_ENG_BOM_ECO_WORKSPACE_HIS - BOM 관련 조회 또는 변경
   * ================================================================
   * [AI 분석] 예외 처리:
   ...
   * [AI 분석] 복잡도:
   *   조건 분기: IF 52회 / 반복문: 7회
   *   DML: SELECT 39회, INSERT 12회, UPDATE 11회, DELETE 7회
   * ================================================================
   * 사용 예시:
