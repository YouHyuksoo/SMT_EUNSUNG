CREATE OR REPLACE PROCEDURE "P_INTERLOCK_SENSOR_ACTUAL_NEO" (
  /* ================================================================
   * 프로시저명  : P_INTERLOCK_SENSOR_ACTUAL_NEO
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2015-12-21
   * 수정이력:
   *   2015-12-21 - 지성솔루션컨설팅 - 최초 작성
   ...
   * ================================================================
   * 사용 예시:
   *   EXEC P_INTERLOCK_SENSOR_ACTUAL_NEO(...)
   * ================================================================ */
...
IS
   ...
   LVS_FEEDER_LAYOUT_NAME       VARCHAR2 (30); -- [AI] 내부 처리용 변수
   LVS_MODEL_SUFFIX     VARCHAR2 (30); -- [AI] 내부 처리용 변수
   ...
   LVF_REAL_ST          NUMBER; -- [AI] 내부 처리용 변수
   LVL_NO_CSS_COUNT     NUMBER; -- [AI] 내부 처리용 변수

   LVL_SENSOR_ACTUAL    NUMBER; -- [AI] 내부 처리용 변수

   LVI_DUAL_COUNT       NUMBER; -- [AI] 내부 처리용 변수
   LVS_LINE_ACTIVE_YN   VARCHAR2 (10); -- [AI] 내부 처리용 변수
   LVS_SMT_MODEL_NAME VARCHAR2(50) ; -- [AI] 내부 처리용 변수

   LVS_LINE_CODE_GROUP VARCHAR2(10) ; -- [AI] 내부 처리용 변수
   LVI_LINE_COUNT NUMBER ; -- [AI] 내부 처리용 변수
   
   lvl_carrier_qty NUMBER; -- [AI] 내부 처리용 변수
   LVI_ADJUST_QTY NUMBER; -- [AI] 내부 처리용 변수
