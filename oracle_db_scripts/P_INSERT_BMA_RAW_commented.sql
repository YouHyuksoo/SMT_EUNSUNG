CREATE OR REPLACE PROCEDURE "P_INSERT_BMA_RAW" (
  /* ================================================================
   * 프로시저명  : P_INSERT_BMA_RAW
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2021-03-14
   * 수정이력:
   *   2021-03-14 - 지성솔루션컨설팅 - 최초 작성
   ...
   *   IQ_MACHINE_INSPECT_DATA_BMA - 원본 로직 참조 테이블
   * ================================================================
   * [AI 분석] 호출 객체:
   *   P_DATA
   *   P_INFO
...
BEGIN
   ...
   lvs_column_count :=  to_char( p_data.LAST ); 
       ...
       INSERT INTO IQ_MACHINE_INSPECT_DATA_BMA (                                                           
                                                 inspect_start_date, 
                                                 inspect_end_date, 
                                                 test_channel, 
                                                 pid, 
                                     ...
                                     VALUES (
                                             ...
                                             TO_CHAR( TO_DATE( REPLACE (TRIM (p_data(1)), '"'), 'YYYY-MM-DD HH24:MI:SS'), 'YYYY/MM/DD HH24:MI:SS'),   -- 2021-03-14 08:52:28  
                                             TO_CHAR( TO_DATE( REPLACE (TRIM (p_data(2)), '"'), 'YYYY-MM-DD HH24:MI:SS'), 'YYYY/MM/DD HH24:MI:SS'),    -- 2021-03-14 08:52:28 
...
EXCEPTION
   ...
   WHEN OTHERS THEN
         ...
         LVS_ERRORMSG := '[P_INSERT_BMA_RAW] ' || SUBSTR (SQLERRM, 1, 200);
