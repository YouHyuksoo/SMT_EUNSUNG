  ...
  IF v_count = 0 THEN
    EXECUTE IMMEDIATE q'[
      CREATE TABLE OEE_RESOURCE (
        ...
        CONSTRAINT CK_OEE_RESOURCE_PROCESS CHECK (PROCESS_CODE IN ('SMT', 'ASSY')),
        CONSTRAINT CK_OEE_RESOURCE_TYPE CHECK (RESOURCE_TYPE IN ('LINE', 'CELL')),
        CONSTRAINT CK_OEE_RESOURCE_USE CHECK (USE_YN IN ('Y', 'N'))
      )
    ]';
  END IF;
END;
