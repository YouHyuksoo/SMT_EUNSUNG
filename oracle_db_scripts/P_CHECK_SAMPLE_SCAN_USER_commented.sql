CREATE OR REPLACE PROCEDURE "P_CHECK_SAMPLE_SCAN_USER" (
  /* ================================================================
   * 프로시저명  : P_CHECK_SAMPLE_SCAN_USER
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2020-07-30
   * 수정이력:
   ...
   *   P_SAMPLE_TYPE - 원본 선언부 기준 입력/출력 파라미터
   ...
   *   IMCN_SAMPLE_APPLY_MODEL - 원본 로직 참조 테이블
...
IS
   ...
   lvs_line_item         VARCHAR2 (50); -- [AI] 내부 처리용 변수
   lvs_line_run_no       VARCHAR2 (50); -- [AI] 내부 처리용 변수
   
   lvs_sample_section    VARCHAR2 (20); -- [AI] 내부 처리용 변수
   lvs_sample_status     VARCHAR2 (20); -- [AI] 내부 처리용 변수
   lvs_item_code         VARCHAR2 (20); -- [AI] 내부 처리용 변수
   lvdt_apply_date       DATE; -- [AI] 내부 처리용 변수
   ...
   lvs_sample_line_code    VARCHAR2 (20); -- [AI] 내부 처리용 변수
   
   lvs_samlple_model_name  VARCHAR2 (50); -- [AI] 내부 처리용 변수
