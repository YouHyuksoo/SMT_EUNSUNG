CREATE OR REPLACE PROCEDURE "P_INSERT_ROUTER_RAW" (
  /* ================================================================
   * 프로시저명  : P_INSERT_ROUTER_RAW
   * 작성자  : 지성솔루션컨설팅
   * 작성일  : 2019-07-10
   * 수정이력:
   ...
   *   IQ_MACHINE_INSPECT_DATA_RT - 원본 로직 참조 테이블
   * ================================================================
   * [AI 분석] 호출 객체:
   *   P_DATA
   *   P_INFO
...
EXCEPTION
   ...
   WHEN OTHERS THEN
        ...
        LVS_ERRORMSG := '[P_INSERT_ROUTER_RAW]' || ' ' || SUBSTR (SQLERRM, 1, 200);
