CREATE OR REPLACE PACKAGE BODY
   ...
   * ================================================================
   * [AI 분석] 공개/구현 객체:
   *   PROCEDURE P_DEBUG - 패키지 내 업무 처리 단위
   *   PROCEDURE P_DBMS_OUTPUT_MATRIX - 패키지 내 업무 처리 단위
   *   FUNCTION BITOR - 패키지 내 업무 처리 단위
   *   FUNCTION BITXOR - 패키지 내 업무 처리 단위
   *   FUNCTION BIN2DEC - 패키지 내 업무 처리 단위
   *   FUNCTION F_INTEGER_2_BINARY - 패키지 내 업무 처리 단위
   *   PROCEDURE P_FILL_LOG_ANTILOG - 패키지 내 업무 처리 단위
   *   FUNCTION F_MATRIX_SIZE - 패키지 내 업무 처리 단위
   *   PROCEDURE P_INIT_MATRIX - 패키지 내 업무 처리 단위
   *   PROCEDURE P_ADD_FINDER - 패키지 내 업무 처리 단위
   *   PROCEDURE P_INIT_ALIGNMENT - 패키지 내 업무 처리 단위
   *   PROCEDURE P_ADD_ALIGNMENT - 패키지 내 업무 처리 단위
   *   PROCEDURE P_FILL_ERR_COR - 패키지 내 업무 처리 단위
   *   FUNCTION F_MODE_NAME - 패키지 내 업무 처리 단위
   *   FUNCTION F_GET_MODE - 패키지 내 업무 처리 단위
   *   FUNCTION F_IS_CHAR_KANJI - 패키지 내 업무 처리 단위
   *   FUNCTION F_ERR_COR_2_NUMBER - 패키지 내 업무 처리 단위
   *   FUNCTION F_MODE_INDICATOR - 패키지 내 업무 처리 단위
   *   FUNCTION F_CHAR_COUNT_INDICATOR - 패키지 내 업무 처리 단위
   *   FUNCTION F_GET_VERSION - 패키지 내 업무 처리 단위
   *   FUNCTION F_EXPLODE - 패키지 내 업무 처리 단위
   *   FUNCTION F_ENCODE_DATA - 패키지 내 업무 처리 단위
   *   FUNCTION F_GET_CODE - 패키지 내 업무 처리 단위
   *   FUNCTION F_FINAL_DATA_WITH_EC - 패키지 내 업무 처리 단위
   *   FUNCTION F_BLOCKS_IN_GROUP - 패키지 내 업무 처리 단위
   *   FUNCTION F_CW_IN_GROUP - 패키지 내 업무 처리 단위
   *   PROCEDURE P_ADD_CW_TO_BLOCK - 패키지 내 업무 처리 단위
   *   PROCEDURE P_DEBUG_COLLECTION - 패키지 내 업무 처리 단위
   *   FUNCTION F_POLY_DIVIDE - 패키지 내 업무 처리 단위
   *   PROCEDURE P_PLACE_FM_IN_MATRIX - 패키지 내 업무 처리 단위
   *   ... 이후 객체는 원본 소스 선언부/본문 참조
   * ================================================================
   * [AI 분석] 참조 테이블:
   *   PREVIOUS - 업무 기준/거래 데이터 조회 또는 변경
   * ================================================================
   * [AI 분석] 예외 처리:
   *   패키지 본문 내 각 PROCEDURE/FUNCTION의 EXCEPTION 블록 또는 호출부 표준 예외 처리를 따른다.
   * ================================================================
   * [AI 분석] 복잡도:
   *   조건 분기: IF 146회 / 반복문: 301회
   *   DML: SELECT 2회, DELETE 4회
   * ================================================================
   * 사용 예시:
   *   EXEC ZT_QR.<PROCEDURE_NAME>(...);
